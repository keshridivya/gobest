...
<link rel="shortcut icon" href="wp-content/themes/clove/images/favicon.png" type="image/x-icon">
  <title>
  Baner Branch - Gobest Dentist </title>
...
if (!empty($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest') {
    ...
    echo "alert('ppppp')";
    header("location:best-dentist-in-baner-pune.php.php.");
...
<section class="root mt-0 pt-0">
    ...
    <div class="row">
      ...
      <div class="col-sm-12">
      <input type="submit" name="subm" class="btn btn-primary" value="Submit" onclick="return confirm('Thanks for Contacting Gobest Dentist. Baner Branch');"><br>
      </div>
    </div>
  </form>
                        </div>
