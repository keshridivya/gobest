...
<link rel="shortcut icon" href="wp-content/themes/clove/images/favicon.png" type="image/x-icon">
	<title>Dental X-Ray Treatment - Gobest Dentist	</title>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="root-info py-3">
                            <h5 style="font-family: Anton, sans-serif;" class="mb-3">DENTAL X-RAYS</h5>
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3"> ‘Dental x-rays are not as complex as they seem to be!’</h2>
                        </div>
                    </div>

                     <div class="col-lg-5 root-order">
                        <div class="root-img">
                            <img src="images/treatment/dental-xray1.png" alt="Dental X-Rays">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="root">
            <div class="container">
                <div class="row">
                    <!-- <div class="col-lg-5 root-order">
                        <div class="root-img">
                            <img src="image/treatment/cavity2.png" alt="Dental Fillings" class="img-fluid">
                        </div>
        ...
        <section class="root">
            <div class="container">
                ...
                <div class="row">
                     <div class="col-lg-5 root-order">
                        <div class="root-img">
                            <img src="images/treatment/dental-xray2.png" alt="Dental X-Rays" class="img-fluid">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-5 root-order"></div>
                   
                </div>
                <div class="row">
                   <!--  <div class="col-lg-5 root-order">
                        <div class="root-img">
                            <img src="image/treatment/dental-xray2.png" alt="Dental X-Rays" class="img-fluid">
                        </div>
                    </div> -->
                    <div class="col-lg-12">
                        <div class="root-info py-5">
                            <h5 style="font-family: Anton, sans-serif;" class="mb-3">WHAT</h5>
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3"> What problems can a dental x-ray detect?</h2>
                           ...
                           <ul class="list-style">
                            ...
                            <li><i class="fa fa-plus"></i> Reveal impacted wisdom teeth</li>
                            <li><i class="fa fa-plus"></i> To determine proper development of teeth in children</li>

                        </ul>
                        <p style="font-size:16px; line-height: 200%;">Looking for dental x-ray treatment in pimprichinchwad?</p>
                         <a href="tel:+917264889986;" class="btn mt-3">CALL US NOW</a>
                ...
                <div class="row">
                    <div class="col-lg-7">
                        <div class="root-info py-4">
                            ...
                            <p style="font-size:16px; line-height: 200%;">These are the types of x-rays recorded by placing the film inside the mouth. These are the most common types of x-rays used in a dental clinic. They can detect many problems from decay to dental development to health of your jawbone. They are used at various stages of <strong><a href="\change\Root-Canal-Treatment.php">root canal treatment</a></strong> to determine the progress.</p>
                            ...
                            1.  Bite-wing x-rays<br>
                            This technique involves biting on a special piece of paper.These type of x-rays are used to see the details of upper and lower jaw in a single image. They show the part of tooth till the level of supporting bone (i.e the crown portion of tooth)<br>
                            These types of x-rays are most commonly used to detect decay in between the teeth. They are often indicated to check the fitting of dental crowns as well as marginal integrity of dental fillings.<br><br>
                            2.  Peri-apical x-rays<br>
                            These types of x-rays show the entire tooth from crown to root. It is the two dimensional image of the whole tooth in focus. One single image can contain 3-4 teeth depending on the size of teeth and area of focus.<br>
                            They are most commonly used to detect abnormalities related to tooth root and surrounding bone.<br><br>
                            3.  Occlusal x-rays<br>
                            These types of x-rays can show all the teeth of either upper arch or lower arch in one single shot.<br>
                            They are used to detect the alignment of teeth and the anomalies associated with the floor of the mouth or the palate.<br><br>

                            <i class="fa fa-plus"></i><b> Types of Extra-oral x-rays.</b><br>

                            1.  Panoramic x-rays<br>
                            It is a type of an extra oral x-ray that can capture the entire mouth in one single image.<br>
                            It is used to plan procedures of surgical extractions or braces. It is also used to detect bone abnormalities, fractures and tumors.<br><br>

                            2.  Computed Tomography<br>
                            It is a three dimensional image of all internal structures of your head, face and neck.<br>
                            They are most commonly used in planning for placing dental implants to know the density of bone in the respective area.<br>
                            It is also used to determine the position of sinus and vital nerves before any major surgical procedure.<br><br>
                            3.  Cephalometric x-rays <br>
                            These type of x-rays are taken from outside the mouth. They reveal the side view of your head showing teeth, jaw and surrounding structures.<br>
                    ...
                    <div class="col-lg-5 root-order">
                        <div class="root-img">
                            <img src="images/treatment/dental-xray4.png" alt="Dental X-Rays" class="img-fluid">
                        </div>
                    </div>
                </div>
              </div>
        ...
        <section class="root">
            <div class="container">
                <div class="row">
                    <div class="col-lg-5 root-order">
                        <div class="root-img">
                            <img src="images/treatment/dental-xray3.png" alt="Dental X-Rays" class="img-fluid">
                        </div>
                    ...
                    <div class="col-lg-7">
                        <div class="root-info py-4">
                            ...
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3"> How are Dental x-rays at GoBest Dentist safe?</h2>
                            <ul class="list-style">
                                <li><i class="fa fa-plus"></i> We use very small amount of radiation while taking x-rays.</li>
                                <li><i class="fa fa-plus"></i> We use digital x-rays which reduces the amount of radiation 80% then the conventional x-rays.</li>
                                <li><i class="fa fa-plus"></i>  We follow ALARA principle which stands for as low a reasonably achievable while taking x-rays.</li>
                                <li><i class="fa fa-plus"></i>  We use the fastest image receptors.</li>
                                <li><i class="fa fa-plus"></i>  We use proper techniques for exposure to minimalize radiation.</li>
                                <li><i class="fa fa-plus"></i>  We use leaded apron whenever possible.</li>
                        ...
                        <div class="accordion md-accordion" id="accordionEx" role="tablist" aria-multiselectable="true">
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingOne1">
                              <a data-toggle="collapse" data-parent="#accordionEx" href="#collapseOne1" aria-expanded="true"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                  Are dental x-rays safe during pregnancy? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                            ...
                            <div id="collapseOne1" class="collapse show" role="tabpanel" aria-labelledby="headingOne1"
                              ...
                              <div class="card-body">
                                Yes, dental x-rays are safe during pregnancy. We take them with all necessary precautions like thyroid collar and lead apron to minimize the exposure to your abdomen. Moreover, dental x-rays utilize a very low amount of radiation.<br>
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingTwo2">
                              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseTwo2"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                  Are dental x-rays safe for children? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                            ...
                            <div id="collapseTwo2" class="collapse" role="tabpanel" aria-labelledby="headingTwo2"
                              data-parent="#accordionEx">
                              <div class="card-body">
                              The radiation exposure from a dental radiograph is even less than the daily radiation exposure by the environmental sources. Our experienced dentists at GoBest Dentist will always weigh risk vs benefit ratio while deciding whetether your kid requires an x-ray or not.
                              </div>
                            </div>
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingThree3">
                              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseThree3"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                   How much radiation does a single dental radiograph expose us to? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                            ...
                            <div id="collapseThree3" class="collapse" role="tabpanel" aria-labelledby="headingThree3"
                              data-parent="#accordionEx">
                              <div class="card-body">
                               In the entire modern medicine, dental x-rays are considered to be one of the smallest radiation dose studies. It is estimated that during a set of 4 bitewing radiographs, a person is exposed to 0.005mSv which is equal to radiation you are exposed to while boarding a flight of one to two hours.
                              </div>
                            </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="offset-lg-4 col-lg-4">
                            <iframe width="100%" height="315" src="https://www.youtube.com/embed/NvGSccJoFW4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                        <!-- <div class="col-lg-4">
