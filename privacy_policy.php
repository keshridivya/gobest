...
<link rel="shortcut icon" href="wp-content/themes/clove/images/favicon.png" type="image/x-icon">
	<title>Privacy Policy - Gobest Dentist	</title>
...
<meta property="og:title" content="Privacy_policy - Clove Dental" />
...
<p><strong>GoBest Dentist</strong>, a brand name of <strong>M/s. Star Dental Centre Private Limited</strong> (referred to as “we”, us”, “GoBest”) is the author and publisher of the internet resource www.gobestdentist.com (website) on the world wide web as well as other software and applications provided by GoBest, including but not limited to the mobile applications (referred to as “App”, and together with Website referred to as “Services”).</p>
<p>This privacy policy (&#8220;<strong>Privacy Policy</strong>&#8220;) explains how we collect, use, share and protect personal information about the Users of the Services. We have created this Privacy Policy to demonstrate our commitment to the protection of your privacy and your personal information. Your use of and access to the Services is subject to this Privacy Policy and our Terms of Use.</p>
...
<h4>1. PRIVACY POLICY EXPLAINED</h4>
<p>This Privacy Policy is published in compliance with, inter alia: i. Section 43A of the Information Technology Act, 2000;</p>
<div class="refund_padding">
<p>a. Regulation 4 of the Information Technology (Reasonable Security Practices and Procedures and Sensitive Personal Information) Rules, 2011 (the “SPI Rules”); and</p>
...
<div class="refund_padding">
<p>a. The type of information collected from the Users, including sensitive personal data or information;</p>
...
<p>c. Data regarding your usage of the services and history of the appointments and other transactions made by or with you through the use of Services;</p>
<p>d. Health or medical data (such as your past medical history and conditions, diagnostic reports, prescriptions and medication history)</p>
<p>e. Other information that you voluntarily choose to provide to us (such as information shared by you with us through emails or letters, your work details, your family details)</p>
</div>
<p>The information collected from you by GoBest Dentist may constitute ‘personal Information’ or ‘sensitive personal data or Information’ under the SPI Rules. Personal information is defined under the SPI Rules to mean any information that relates to a natural person, which, either directly or indirectly, in combination with other information available or likely to be available with a body corporate, is capable of identifying such person.</p>
...
<div class="refund_padding">
<p>a. A condition of each User’s use of and access to the Services is their acceptance of the Terms of Use, which also involves acceptance of the terms of this Privacy Policy. Any User that does not agree with any provisions of the same has the option to discontinue the Services provided by GoBest Dentist immediately.</p>
<p>b. All the information provided to us by a User, including sensitive personal information, is voluntary. You understand that GoBest Dentist , either itself or with its Partners, may use certain information of yours, which has been designated as ‘sensitive personal data or Information’ under the SPI Rules, (a) for the purpose of providing you the Services, (b) for commercial purposes and in an aggregated or non- personally identifiable form for research, statistical analysis and business intelligence purposes, for (c) for sale or transfer of such research, statistical or intelligence data in an aggregated or non-personally identifiable form to our Partners. GoBest Dentist also reserves the right to use information provided by or about the User for the following purposes:</p>
<div class="refund_padding">i. Publishing such information on the Website.<br />
ii. Contacting Users for offering new products or services.<br />
iii. Contacting Users for taking product and Service feedback.<br />
iv. Analyzing software usage patterns for improving product design and utility.</div>
</div>
<p>You hereby consent to such use of such information by GoBest Dentist  and our Partner.</p>
<div class="refund_padding">
...
<p>d. You are responsible for maintaining the accuracy of the information you submit to us, such as your contact information provided as part of account registration. If your personal information changes, you may correct, delete inaccuracies, or amend information by making the change on your profile information page on the Websites or App or by contacting us at <a style="text-decoration: underline;" href="contact-us.php" target="_blank" rel="noopener noreferrer">https://www.gobestdentist.com/contact-us/</a> . We will make good faith efforts to make requested changes in our then active databases as soon as reasonably practicable.</p>
<p>e. If you wish to cancel your account or request that we no longer use your information to provide you services, contact us through <a style="text-decoration: underline;" href="contact-us.php" target="_blank" rel="noopener noreferrer">https://www.gobestdentist.com/contact-us/</a> . We will retain your information for as long as your account with the Services is active and as needed to provide you the Services. We shall not retain such information for longer than is required for the purposes for which the information may lawfully be used or is otherwise required under any other law for the time being in force.</p>
<p>f. GoBest Dentist  may require the User to pay with a credit card, debit card, net banking or other online payment mechanisms for Services for which an amount(s) is/are payable. GoBest Dentist  will collect such User’s credit card number and/or other financial institution information such as bank account numbers and will use that information for the billing and payment processes, including but not limited to the use and disclosure of such credit card number and information to third parties as necessary to complete such billing operation.</p>
<p>g. In order to have access to all the features and benefits on our Website or App, a User must first create an account on our Website or App. To create an account, a User is required to provide the following information, which such User recognizes and expressly acknowledges is personal information allowing others, including GoBest Dentist , to identify the User: name, User ID, email address, address, date of birth, gender, phone number and password chosen by the User. Other optional information may be requested on the registration page. We may, in future, include other optional requests for information from the User to help us to customize the Services to deliver personalized information to the User. However, We assume your consent in relation to various matters, once you complete the registration process.</p>
<p>h. This Privacy Policy applies to Websites, App and Services that are owned and operated by GoBest Dentist . GoBest Dentist  does not make any representations concerning the privacy practices or policies of such third parties or terms of use of such websites, nor does GoBest Dentist  guarantee the accuracy, integrity, or quality of the information, data, text, software, sound, photographs, graphics, videos, messages or other materials available on such websites.</p>
<p>i. The Website may use cookies to store certain data (that is not sensitive personal data or information) that is used by us and our partners for the technical administration of the Website, App, research and development, and for User administration. In the course of serving advertisements or optimizing services to its Users, GoBest may allow authorized third parties to place or recognize a unique cookie on the User’s browser. The cookies however, do not store any personal information of the User.</p>
...
<p>k.  GoBest Dentist  has implemented best international market practices and security policies, rules and technical measures to protect the personal data that it has under its control from unauthorized access, improper use or disclosure, unauthorized modification and unlawful destruction or accidental loss. However, for any data loss or theft due to unauthorized access to the User’s electronic devices through which the User avails the Services, GoBest Dentist  or its Partners shall not be held liable for any loss whatsoever incurred by the User.</p>
<p>l. GoBest Dentist  takes your right to privacy very seriously and other than as specifically stated in this privacy Policy, will only disclose your personal information in the event it is required to do so by law, rule, regulation, law enforcement agency, governmental official, legal authority or similar requirements or when GoBest Dentist , in its sole discretion, deems it necessary in order to protect its rights or the rights of others, to prevent harm to persons or property, to fight fraud and credit risk, or to enforce or apply the Terms of Use.</p>
</div>
<h4>4. CONFIDENTIALITY AND SECURITY</h4>
<div class="refund_padding">
<p>a. Your Personal Information is maintained by GoBest Dentist  in electronic form on its or its employees and Partners equipment. Such information may also be converted to physical form from time to time. We take necessary precautions to protect your personal information both online and off-line, and implement reasonable security practices and measures including certain managerial, technical, operational and physical security control measures that are commensurate with respect to the information being collected and the nature of GoBest Dentist’s business.</p>
<p>b. No administrator at  GoBest Dentist  will have knowledge of your password. It is important for you to protect against unauthorized access to your password, your computer and your mobile phone or device. Be sure to log off from the Website when finished. GoBest Dentist  and its Partners do not undertake any liability for any unauthorized use of your account and password. If you suspect any unauthorized use of your account, you must immediately notify GoBest Dentist  by contacting us at <a style="text-decoration: underline;" href="contact-us.php" target="_blank" rel="noopener noreferrer">https://www.gobestdentist.com/contact-us/</a> . You shall be liable to indemnify  GoBest Dentist , its employees and Partners due to any loss suffered by them due to such unauthorized use of your account and password.</p>
<p>c. GoBest Dentist  makes all User information accessible to its employees only on a need-to-know basis.</p>
<p>d. Notwithstanding the above, GoBest Dentist  is not responsible for the confidentiality, security or distribution of your personal information by our Partners and third parties outside the scope of our agreement with such Partners and third parties. Further, GoBest Dentist  and its Partners shall not be responsible for any breach of security or for any actions of any third parties or events that are beyond the reasonable control of GoBest Dentist  and its Partners including, acts of government, computer hacking, unauthorized access to computer data and storage device, computer crashes, breach of security and encryption, poor quality of Internet service or telephone service of the User etc.</p>
</div>
<h4>5. CHANGE TO PRIVACY POLICY</h4>
<p>GoBest Dentist  may update this Privacy Policy at any time, with or without advance notice. If you object to any of the changes to our terms, and you no longer wish to use the Services, you may contact <a style="text-decoration: underline;" href="contact-us.php" target="_blank" rel="noopener noreferrer">https://www.gobestdentist.com/contact-us/</a> to deactivate your account. Unless stated otherwise, GoBest Dentist’s current Privacy Policy applies to all information that GoBest Dentist  has about you and your account.</p>
<p>If a User uses the Services or accesses the Website or uses the App after a notice of changes has been sent to such User or published on the Website, such User hereby provides his/her/its consent to the changed terms.</p>
<h4>6. CONSENT TO THIS POLICY</h4>
...
<h4>7. ADDRESS FOR PRIVACY QUESTIONS</h4>
<p>Should you have questions about this Privacy Policy or GoBest Dentist &#8217;s information collection, use and disclosure practices, you may contact us at below details. We will use reasonable efforts to respond promptly to any requests, questions or concerns, which you may have regarding our use of your personal information.</p>
<p>Email: gobestdentist@gmail.com</p>
<p>Contact No. +91 72648 89986</p>
</div>
</div>
<!-----------------Video News------------------>
</div>
