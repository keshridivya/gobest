...
<link rel="shortcut icon" href="wp-content/themes/clove/images/favicon.png" type="image/x-icon">
	<title>Full Mouth Rehabilitation / Smile Designing - Gobest Dentist	</title>
  	...
  	<div class="breadcrumb" style="background:white;margin:0">
		<div class="box">
			<ul>
				...
				<li>Full Mouth Rehabilitation / Smile Designing </li>
			</ul>
		</div> 
	</div>
  ...
  <section class="root">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="root-info py-3">
                            ...
                            <h2  style="font-family: Anton, sans-serif;" class="mb-3"> ‘A systematic approach to smile restoration!’</h2>
                            
                        </div>
                    </div>
                   <!--  <div class="col-lg-5 root-order">
                        <div class="root-img pb-5">
                            <img src="image/treatment/Flap-Surgery1.png" alt="Full mouth rehabilitation surgery" class="img-fluid">
                        </div>
                ...
                <div class="row">
                    <!-- <div class="col-lg-5 root-order">
                        <div class="root-img pb-5">
                            <img src="image/treatment/Flap-Surgery2.png" alt="Full mouth rehabilitation surgery" class="img-fluid">
                        </div>
                    ...
                    <div class="col-lg-12">
                        <div class="root-info py-4">
                            ...
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3"> What is complete oral cavity rehabilitation?</h2>
                            <p style="font-size:16px; line-height: 200%;">Oral rehabilitation is the artificial restoration of the teeth, jaw, gums, and other structures of the mouth and face.</p>
                            <p style="font-size:16px; line-height: 200%;">Depending on your situation and the type of treatment you need, rehabilitation can be performed exclusively by a dentist or by a team of dentists and oral surgeons specialized in various fields such as endodontists, orthodontists, periodontists, and restorative dentists. Our specialist team of doctors will recommend a comprehensive treatment plan to help restore the entire structure of your mouth and will also help you prevent further damage.</p>
                           
                            <p style="font-size:16px; line-height: 200%;" class="moretext">Complete oral rehabilitation usually involves several procedures that are performed over several appointments. However, some procedures, such as dental implantation, can be performed in one visit at our dental clinic.<br> These procedures replace missing or damaged teeth with strong, durable dentures that look, feel and function like natural teeth. They also help repair lost gums and bone and stimulate the growth of new bone in the jaw.</p>
                ...
                <div class="row">
                    <div class="col-lg-5 root-order">
                        <div class="root-img pb-5">
                            <img src="images/treatment/full-mouth-rehabitation1.png" alt="Full mouth rehabilitation surgery" class="img-fluid">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-7">
                        <div class="root-info py-5">
                            ...
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3">  Who Can Benefit From Complete Oral Rehabilitation?</h2>
                            <p style="font-size:16px; line-height: 200%;">We may recommend a complete reconstruction if there is severe damage to your teeth, gums, or jaw.</p>
                            <p style="font-size:16px; line-height: 200%;">The most common reasons for complete mouth rehabilitation are:</p>
                            <ul class="list-style">
                                <li><i class="fa fa-plus"></i> You have only a few healthy teeth in the mouth or none at all</li>
                                <li><i class="fa fa-plus"></i> Teeth are badly damaged as a result of decay, trauma, or other trauma</li>
                                <li><i class="fa fa-plus"></i> Teeth have been excessively worn by grinding (bruxism)</li>
                                <li><i class="fa fa-plus"></i> Gums have been damaged by periodontal disease</li>
                                <li><i class="fa fa-plus"></i> You have a bite problem (wrong bite).</li>
                            </ul>

                            <p style="font-size:16px; line-height: 200%;" class="moretext1">Full rehabilitation can often be a more affordable and convenient option than single dental implants if you need to replace multiple teeth. These procedures are aimed at restoring the strength and function of the mouth, as well as its appearance.</p>
                ...
                <div class="row">
                    <div class="col-lg-7">
                        <div class="root-info py-5">
                            <h5 style="font-family: Anton, sans-serif;" class="mb-3">OPTIONS</h5>
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3"> Options for complete oral cavity rehabilitation at GoBest Dentist</h2>
                            <p style="font-size:16px; line-height: 200%;">Our dentist will take a thorough examination of your mouth to determine the most suitable treatment plan for you. This will involve the use of dental x-rays and may require an oral impression to create implants, crowns, and other prostheses.</p>
                            <p style="font-size:16px; line-height: 200%;">Depending on your situation, a complete mouth rehabilitation may include one or more of the following procedures:
                            </p>
                        </div>
                    </div>
                        <div class="col-lg-5 root-order">
                            <div class="root-img">
                                 <img src="images/treatment/full-mouth-rehabitation2.png" alt="Full mouth rehabilitation surgery" class="img-fluid">
                            </div>
                        </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <p style="font-size:16px; line-height: 200%;"><b>Veneers</b><br>
                            <p style="font-size:16px; line-height: 200%;">Dental veneers are thin porcelain or composite resin restorations that are placed on the front of the teeth to enhance their appearance. Veneers are less intensive treatments than dental implants and crowns.</p>
                            <p style="font-size:16px; line-height: 200%;">This cosmetic dental treatment is less likely to affect oral health, and veneers can help cover stains or discoloration, close minor gaps, and straighten crooked teeth.</p>
                        </p><br>
                         ...
                         <div class="row">
                             <div class="col-lg-5"> 
                                <div class="root-img py-3">
                                    <img src="images/treatment/full-mouth-rehabitation3.png" alt="Full mouth rehabilitation surgery">
                                </div>
                            </div>
                             <div class="col-lg-7">
                                 <div class="root-info py-3">
                                     <p style="font-size:16px; line-height: 200%;">If your malocclusion is too severe to be treated with orthodontics, our dentist may recommend jaw surgery (orthognathic surgery). This includes aligning and repositioning the jaw, which can help with bite problems and temporomandibular joint problems.</p>
                                </div>
                            </div>
                          </div> 
                       </p>
                        ...
                        <div class="accordion md-accordion" id="accordionEx" role="tablist" aria-multiselectable="true">
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingOne1">
                              <a data-toggle="collapse" data-parent="#accordionEx" href="#collapseOne1" aria-expanded="true"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                  How long does it take? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                            ...
                            <div id="collapseOne1" class="collapse show" role="tabpanel" aria-labelledby="headingOne1"
                              ...
                              <div class="card-body">
                                The length and extent of full mouth rehabilitation will depend on how serious your condition is and the type of treatment you choose.In more severe cases, treatment may involve several appointments and if you are undergoing less intensive treatment or using All-on-4 implants, a complete mouth rehabilitation can sometimes be done in one visit.
                              </div>
                            </div>
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingTwo2">
                              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseTwo2"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                  How can missing tooth create problem? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                            ...
                            <div id="collapseTwo2" class="collapse" role="tabpanel" aria-labelledby="headingTwo2"
                              data-parent="#accordionEx">
                              <div class="card-body">
                               Missing teeth does not only affect the outer appearance but it can also cause a variety of issues related oral health. Even if a single tooth is missing, it will cause adjacent teeth to shift into that empty space. In long term, missing teeth can cause facial sagging.
                              </div>
                            </div>
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingThree3">
                              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseThree3"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                   Is it a painful process? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                            ...
                            <div id="collapseThree3" class="collapse" role="tabpanel" aria-labelledby="headingThree3"
                              data-parent="#accordionEx">
                              <div class="card-body">
                                We take utmost care to make the procedure as comfortable for you as possible. You will be numb for the entire process which means you will be conscious but won’t feel any pain. There might be a little discomfort.
                              </div>
                            </div>
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingThree4">
                              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseThree4"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                   Is Full mouth rehabilitation expensive? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                            ...
                            <div id="collapseThree4" class="collapse" role="tabpanel" aria-labelledby="headingThree4"
                              data-parent="#accordionEx">
                              <div class="card-body">
                                The entire cost of treatment depends upon several factors like type of dental materials used, extent of damage, type of sedation etc. Visit our near branch today to know the cost estimation for your mouth.
