...
<link rel="shortcut icon" href="wp-content/themes/clove/images/favicon.png" type="image/x-icon">
	<title>Invisalign-Clear-Aligners - Gobest Dentist	</title>
...
<?php include("include/treatments.php") ?>
    ...
    <div class="col-lg-12">
        ...
        <div class="root-info py-3">
            ...
            <h5 style="font-family: Anton, sans-serif;" class="mb-3">INVASALIGN</h5>

            <h2 style="font-family: Anton, sans-serif;" class="mb-3"> ‘Get a smile that will change your life for the better!’</h2>
...
<div class="col-lg-5 pr-xl-0">
        ...
        <img src="images/treatment/INVISALIGN-1.png" alt="INVISALIGN" class="img-fluid">
    ...
    <div class="col-lg-7">
        ...
        <div class="root-info py-4">
            ...
            <h2 style="font-family: Anton, sans-serif;" class="mb-3"> Invisalign: What you need to know?</h2>
...
<div class="row">
    ...
    <div class="col-lg-7">
        ...
        <div class="root-info py-5">
            ...
            <h2 style="font-family: Anton, sans-serif;" class="mb-3">  How do Invisalign aligners work?</h2>

           <p style="font-size:16px; line-height: 200%;">Before starting the treatment, dental impressions are taken and the desired result is modelled. After that, a plant manufactures a set of mouth guards for the entire treatment period using computer models. Each mouth guard is worn for about two weeks, after which it must be replaced with the next one. This allows you to gently move the teeth, gradually approaching the desired result.</p>

            <p style="font-size:16px; line-height: 200%;">Want a perfectly crafted smile?</p>
    ...
    <div class="col-lg-5 root-order">
        ...
        <div class="root-img pb-5">
            ...
            <img src="images/treatment/INVISALIGN-2.png" alt="INVISALIGN" class="img-fluid">
...
<div class="dental root">
  ...
  <div class="container">
    ...
    <h2 style="font-family: Anton, sans-serif;" class="mb-3"> How long do bite correction guards wear?</h2>

    <p  style="line-height: 200%;"> Depending on the type and severity of the malocclusion, treatment with aligners can take from 4-5 months to 2.5 years. The result depends largely on how accurately the patient follows the recommendations for wearing aligners and how carefully they treat them. </p>

    <p  style="line-height: 200%;" class="moretext1">If one of the aligners is damaged, the course of treatment may be disrupted. In addition, mouth guards cannot be removed for a long time - to achieve the desired result, you need to wear a mouth guard for at least 20-22 hours a day.<br>Bite correction with aligners is a modern and effective method of orthodontic treatment. Invisalign aligners are not visible to others, they do not injure the oral mucosa and do not interfere with your normal life. However, they require great independence and responsibility of the patient. It is necessary to be careful with aligners, do not take them off for a long time and do not forget to change them in time. Only in this case can you achieve the planned result.</p>

    <a class="moreless-button1" style="color:orange;" href="javascript:void()">Read more</a><br>

    <p  style="line-height: 200%;">Want a painless smile correction ?</p>
...
<div class="row">
    ...
    <div class="col-lg-5 root-order">
        ...
        <div class="root-img pb-5">
            ...
            <img src="images/treatment/INVISALIGN-3.png" alt="INVISALIGN" class="img-fluid">
    ...
    <div class="col-lg-7">
        ...
        <div class="root-info py-5">
            ...
            <h2 style="font-family: Anton, sans-serif;" class="mb-3"> What Are The Advantages Of Invasalign ?</h2>

            <p style="font-size:16px; line-height: 200%;">Mouth aligners are increasingly recommended by orthodontists as an alternative to braces. Their pluses:Efficiency of bite correction comparable to braces The only drawback of caps is their price. The cost of a set of caps is quite high. Nevertheless, you can choose this particular method of bite correction for its effectiveness and comfort.
            ...
            <ul class="list-style">
                ...
                <li><i class="fa fa-plus"></i><b> Aesthetics</b> <p style="font-size:16px; line-height: 200%;">Unlike metal, ceramic or sapphire braces, aligners are completely transparent and fit tightly to the teeth, making them completely invisible. In addition, aligners are removable structures, which allows them to be removed if necessary.</p></li>
    ...
    <div class="col-lg-12">
        ...
        <ul class="list-style">
                ...
                <li><i class="fa fa-plus"></i><b> Hygiene</b><p style="font-size:16px; line-height: 200%;">The ability to maintain complete dental careis one of the main advantages of Invisalign and advantages over braces. This is a very important factor in preventing the development of caries and its complications.</p></li>

                <li><i class="fa fa-plus"></i><b> Individual approach</b><p style="font-size:16px; line-height: 200%;">Invisalign aligners are made individually based on your clinical situation. Using 3D technologies and modelling, a virtual model of your teeth is created in the laboratory, on which the attending physician will work on the construction of the bite. After obtaining the desired result, a set of aligners is made.</p></li>

                <li><i class="fa fa-plus"></i><b> Suitable for teens and adults</b><p style="font-size:16px; line-height: 200%;">The Invisalign System is suitable for both adults and adolescents. The Teen version is a slightly modified system in which it is possible to control the use of aligners by the child, while maintaining efficiency and the same cost.</p></li>
            ...
            <p style="font-size:16px; line-height: 200%;">Don’t want to go for traditional braces?</p>

            <a href="javascript:void()" onclick="openNav()" class="btn mt-3 toggle1 display">BOOK AN APPOINTMENT </a><br><br>
            ...
            <div class="card-header" role="tab" id="headingOne1">
              ...
              <a data-toggle="collapse" data-parent="#accordionEx" href="#collapseOne1" aria-expanded="true"
                ...
                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                 ...
                 What kind of orthodontic problems can be solved with invisalign? <i class="fa fa-angle-down rotate-icon"></i>
          ...
          <div class="card">
            ...
            <div class="card-header" role="tab" id="headingTwo2">
              ...
              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseTwo2"
                ...
                Is this a new method for straightening teeth?  <i class="fa fa-angle-down rotate-icon"></i>
          ...
          <div class="card">
            ...
            <div class="card-header" role="tab" id="headingThree3">
              ...
              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseThree3"
                ...
                How often should Aligners be worn? <i class="fa fa-angle-down rotate-icon"></i>
          ...
          <div class="card">
            ...
            <div class="card-header" role="tab" id="headingThree4">
              ...
              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseThree4"
                ...
                Will aligners affect my speech?<i class="fa fa-angle-down rotate-icon"></i>
          ...
          <div class="card">
            ...
            <div class="card-header" role="tab" id="headingThree5">
              ...
              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseThree5"
                ...
                What’s the best way to clean aligners?  <i class="fa fa-angle-down rotate-icon"></i>
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="offset-lg-4 col-lg-4">
            ...
            <iframe width="100%" height="315" src="https://www.youtube.com/embed/BpMz5xc8zwQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
