...
<link rel="shortcut icon" href="wp-content/themes/clove/images/favicon.png" type="image/x-icon">
	<title>Children-Pediatric-Dentistry - Gobest Dentist	</title>
  	...
  	<div class="breadcrumb">
		<div class="box">
			<ul>
				...
				<li>Children-Pediatric-Dentistry</li>
			</ul>
		</div> 
	</div>
                ...
                <?php include("include/treatments.php") ?>
                    ...
                    <div class="col-lg-12">
                        <div class="root-info py-3">
                            <h5 style="font-family: Anton, sans-serif;" class="mb-3">PEDIATRIC TREATMENT</h5>
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3"> ‘We are experienced in treating the little ones!’</h2>
                             <p style="font-size:18px;  line-height: 200%;">Children are undoubtedly the most important thing for us. In the dental chair, our team of dentists, with a clear and simple language, explains step by step everything they are going to feel, so that the treatment is carried out in a pleasant and relaxed environment  and mainly going to be painless.</p>
                            <p style="font-size:18px; line-height: 200%;">Our goal will be to minimize the number of cavities in our little ones. For this we use the GoBest Dentist METHOD, where we offer an individualized preventive protocol according to the caries risk of each child, explained and analyzed by Dr. Sana mokashi.</p>
                            <p style="font-size:18px; line-height: 200%;">At the GoBest Dentist we cover most of the treatments that fall within the children's dental field.</p>
                ...
                <div class="row" >
                    ...
                    <div class="col-lg-12">
                        <div class="root-info py-4">
                            ...
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3">  	Treatments we offer:</h2>
                         <p style="font-size:18px; line-height: 200%;">We are going to mention a list with the paediatric dentistry treatments most common in children. In this way, you will be able to know which the most common conditions are and how to solve them.</p>
                       <ul class="list-style">
                           <li><b>1. Groove and fissure sealants</b><br>
                           <p style="font-size:18px; line-height: 200%;">Fissure sealants are one of the most common procedures in children. It is a treatment designed to fill any cracks that may appear on the surface of the teeth. A painless and very easy to perform method that will protect children from cavities.</p></li><br><br>
                            <li><b>2. Pulpectomy</b><br>
                                 <div class="row">
                                 <div class="col-lg-5"> <div class="root-img py-3">
                            <img src="images/treatment/paediatric-1.png" alt="Root Canal">
                        </div></div>
                                 <div class="col-lg-7">
                                 <div class="root-info py-3">
                        ...
                        <li><b>3. Dental fillings</b><br>
                        <div class="row">
                                 
                                 <div class="col-lg-7">
                                 <div class="root-info py-3">
                                     <p style="font-size:18px; line-height: 200%;">Dental filling is another paediatric dentistry treatment used to treat cavities. It is popularly known by the name of "cement filling" and is often used in both adults and children. These cavities if they are not treated, they end up affecting the nerve, so they must be treated as soon as possible to avoid discomfort and future problems.</p>
                                 </div>
                                    </div>
                                    <div class="col-lg-5"> <div class="root-img py-3">
                            <img src="images/treatment/paediatric-2.png" alt="Root Canal">
                        </div></div>
                                 </div>
                        </li>
                       ...
                       <a href="contact-us.php" class="btn mt-3">CONTACT US </a>
                        ...
                        <li><b>5. Brackets</b><br>
                          
                          <p style="font-size:18px; line-height: 200%;">We also have to talk about the treatments that are designed for a correct development of the jaw bones and teeth: the placement of dental brackets also known as braces. It is a method designed to correct any alteration or abnormality of bone or dental development that may be inside the child's mouth.. For example, these appliances can be used in the case of a poorly developed or poorly positioned lower jaw.</p>
                          
                       </li><br><br>
                       <li>
                       <b>6. Space maintainer</b><br>
                                 <div class="row">
                                 <div class="col-lg-5"> <div class="root-img py-3">
                            <img src="images/treatment/paediatric-3.png" alt="Root Canal">
                        </div></div>
                                 <div class="col-lg-7">
                                 <div class="root-info py-3">
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingOne1">
                              <a data-toggle="collapse" data-parent="#accordionEx" href="#collapseOne1" aria-expanded="true"
                                ...
                                How often do you need to visit the dentist for your child?<i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingTwo2">
                              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseTwo2"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                 Are sealants really useful? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingThree3">
                              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseThree3"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                               Is childhood bruxism a concern?<i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingThree4">
                              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseThree4"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                What are the options to protect child’s teeth during sports?<i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="offset-lg-4 col-lg-4">
                            <iframe width="100%" height="315" src="https://www.youtube.com/embed/prmCfCwhEeI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
