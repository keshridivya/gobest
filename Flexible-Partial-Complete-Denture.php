...
<link rel="shortcut icon" href="wp-content/themes/clove/images/favicon.png" type="image/x-icon">
	<title>Flexible Partial & Complete Denture - Gobest Dentist	</title>
  	...
  	<div class="breadcrumb"  style="background:white;margin:0">
		<div class="box">
			<ul>
				...
				<li>Flexible Partial & Complete Denture</li>
			</ul>
		</div> 
	</div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="root-info py-3">
                            <h5 style="font-family: Anton, sans-serif;" class="mb-3">Flexible Partial/Complete Denture</h5>
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3"> ‘Gone are the days of dentures that were bulky and uncomfortable!’</h2>
                            <p style="font-size:16px; line-height: 200%;">Dentures made of acrylic and Valplast are popular instruments in dental practice, which are used to replace teeth that have been lost or removed for various reasons. </p>
                            <p style="font-size:16px; line-height: 200%;" class="moretext">Prosthetics is used both for single teeth and in their complete absence. This method of treatment includes several different methods, and it is easy to choose the one that is suitable for the cost and comfort. They are designed to accurately fit over your gums. These are not any recent inventions. They have been in use since ages but the materials used were different than the present day materials.</p>
        ...
        <div class="dental root">
                  <div class="container">
                    <h5 style="font-family: Anton, sans-serif;" class="mb-3">WHAT</h5>
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3"> What types of dentures are there?</h2>
                    <div class="row">
                     

                      <div class="col-lg-7">
                        <div class="root-info">
                            <h3 style="width:100%; font-family: Anton,sans-serif;"> Removable partial dentures</h3>
                            <h3 style="width:100%; font-family: Anton,sans-serif;"> Complete dentures</h3>
                            <h3 style="width:100%; font-family: Anton,sans-serif;"> Implant supported dentures</h3>
                           
                        </div>
                      </div>
                        <div class="col-lg-5">
                        <div class="">
                            <img src="images/treatment/Dentures1.png" alt="Dentures" class="img-fluid">
                        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="root-info py-4">
                            <!-- <h5 class="mb-3">WHAT</h5> -->
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3">   Removable partial dentures</h2>
                            <p style="font-size:16px; line-height: 200%;">This type is used when several teeth need to be replaced, and it is not always important whether they go in a row or whether they remain healthy between the holes. If you have lack of supporting teeth to act as a foundation for fixed crown and bridges or a financial constraint, removable dentures is the best choice for you.</p>
                            <p style="font-size:16px; line-height: 200%;" class="moretext1">They are used both for temporary prosthetics in order to avoid deformation of the bone tissue, and for the installation of permanent artificial teeth.<br>
                            ...
                            <p style="font-size:16px; line-height: 200%;">Cannot afford fixed teeth replacement?</p>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="root-info py-4">
                            <!-- <h5 class="mb-3">WHAT</h5> -->
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3"> Complete dentures</h2>
                            <p style="font-size:16px; line-height: 200%;">Such constructions are used when teeth are completely absent in the oral cavity or most of them. Full dentures restore jaw function but require replacement every three years. They are divided into two types by material:</p>
                            <ul class="list-style">
                                <li><i class="fa fa-plus"></i> Acrylic. In fact, this is a complete removable plate prosthesis, based on a plastic molded mass.
                                <li><i class="fa fa-plus"></i> Valplast. More flexible systems made from suitable material.

                            </ul>
                            <p style="font-size:16px; line-height: 200%;" class="moretext2">Such prostheses are attached due to the vacuum effect, although in cases of soft tissue atrophy, it is recommended to use additional means that increase the degree of fixation.<br>
                            Removable prostheses are the most inexpensive, and sometimes the only possible way to replace all previously lost teeth, but they have certain disadvantages:<br>
                            <i class="fa fa-plus"></i> impair taste and speech functions<br>
                            <i class="fa fa-plus"></i> can cause tissue atrophy under the prosthesis; in order to avoid this, it is necessary to timely relocate the prosthesis
                            </p>
                ...
                <div class="row">
                     <div class="col-lg-5 root-order">
                        <div class="root-img">
                            <img src="images/treatment/Dentures2.png" alt="Flexible Partial/Complete Denture" class="img-fluid">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-7">
                        <div class="root-info py-4">
                            ...
                            <p style="font-size:16px; line-height: 200%;">Searching for best fitting prosthesis?</p>
        ...
        <section class="root">
            <div class="container">
                ...
                <div class="row">
                   <!--   <div class="col-lg-5 root-order">
                        <div class="root-img">
                            <img src="image/treatment/dental-xray2.png" alt="Flexible Partial/Complete Denture" class="img-fluid">
                        </div>
                    </div> -->
                    ...
                    <div class="col-lg-12">
                        <div class="root-info py-5">
                            <h5 style="font-family: Anton, sans-serif;" class="mb-3">WHAT</h5>
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3"> What is special about flexible dentures?</h2>
                            <p style="font-size:16px; line-height: 200%;">Flexible dentures are a relatively new type of removable prosthetics.Flexible dentures are made of thermoplastics - translucent, elastic materials, the structure of which makes it possible to simulate the oral mucosa. The range of thermoplastics that make it possible to manufacture light, durable, metal-free removable dentures is very wide. </p>
                            <p style="font-size:16px; line-height: 200%;" class="moretext5">It is a highly flexible and durable polymer. It differs from plastic in that it does not contain monomer, therefore it does not cause allergic reactions in the body.<br>
                   ...
                   <!--  <div class="col-lg-5 root-order">
                        <div class="root-img pb-5">
                            <img src="image/treatment/cavity3.png" alt="Dental Fillings" class="img-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="root-info py-5">
                            <h5 style="font-family: Anton, sans-serif;" style="font-family: Anton, sans-serif;" class="mb-3">REMINDER</h5>
                            <h2 style="font-family: Anton, sans-serif;" style="font-family: Anton, sans-serif;" class="mb-3"> A reminder to the patients who havestarts using removable dentures</h2>
                           
                           <p style="font-size:16px; line-height: 200%;">All removable dentures take some getting used to. The first few days, when the irritation phase occurs, the prosthesis causes a lot of negative emotions. It's always like that. Everyone has. It all depends on your physiological characteristics of the body, but you need to go through a day or another.</p>
                        <p style="font-size:16px; line-height: 200%;">During this period, it is imperative to see your dentist for the correction of the prosthesis. We, at GoBest Dentist will be more than happy to help you solve the problem.</p>
                            <p style="font-size:16px; line-height: 200%;">Just as regular dental care and hygiene, removable dentures also need hygiene. Brush and paste twice a day. If you do not do this, then soon you will begin to be bothered by an unpleasant smell.
                            That's all the restrictions. With good fixation, removable dentures can be used perfectly.
                     ...
                     <div class="col-lg-5 root-order">
                        <div class="root-img">
                            <img src="images/treatment/Dentures3.png" alt="Flexible Partial/Complete Denture" class="img-fluid">
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="root-info py-4">
                            ...
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3">  Why choose us for getting your dentures?</h2>
                            <ul class="list-style">
                                <li><i class="fa fa-plus"></i> Accurate fit</li>
                                <li><i class="fa fa-plus"></i> Natural aesthetics</li>
                                <li><i class="fa fa-plus"></i> Light weight dentures</li>
                                <li><i class="fa fa-plus"></i> Hassle free process</li>
                                <li><i class="fa fa-plus"></i> Supportive staff</li>
                                <li><i class="fa fa-plus"></i> Experienced technicians</li>
                                <li><i class="fa fa-plus"></i> Full post denture delivery support.</li>
                            </ul>
...
<!--                     <div class="col-lg-5 root-order">
                        <div class="root-img">
                            <img src="image/treatment/dental-xray4.png" alt="Flexible Partial/Complete Denture" class="img-fluid">
                        </div>
                    </div> -->
                </div>
                        ...
                        <div class="accordion md-accordion" id="accordionEx" role="tablist" aria-multiselectable="true">
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingOne1">
                              <a data-toggle="collapse" data-parent="#accordionEx" href="#collapseOne1" aria-expanded="true"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                  What is the best way to clean dentures? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                            ...
                            <div id="collapseOne1" class="collapse show" role="tabpanel" aria-labelledby="headingOne1"
                              ...
                              <div class="card-body">
                                Denture care is just as important as caring for your own teeth. Conventional toothpastes used on natural teeth are not suitable for dentures as they can scratch the surface. Dentures need to be cleaned daily, and because they are different from natural teeth, they require specialized products that are designed to effectively remove bacteria and reduce plaque and stain formation when used correctly.
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingTwo2">
                              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseTwo2"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                  Can denture be worn at night? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                            ...
                            <div id="collapseTwo2" class="collapse" role="tabpanel" aria-labelledby="headingTwo2"
                              data-parent="#accordionEx">
                              <div class="card-body">
                              It is preferable that you remove your denture at night. It gives your gums and bone a chance to relax. Dentures should be stored in water over night after cleaning them properly. They should never be worn for whole 24 hours without performing proper oral hygiene measures.
                              </div>
                            </div>
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingThree3">
                              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseThree3"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                  Is it easy to get adjusted to eat with dentures? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                            ...
                            <div id="collapseThree3" class="collapse" role="tabpanel" aria-labelledby="headingThree3"
                              data-parent="#accordionEx">
                              <div class="card-body">
                               You may take some time to get used to eating normally with your new set of teeth. We advise you to start with soft foods and gradually move towards more harder and sticky foods.
                              </div>
                            </div>
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingThree3">
                              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseFour"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                  Is it a painful procedure? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                            ...
                            <div id="collapseFour" class="collapse" role="tabpanel" aria-labelledby="headingThree3"
                              data-parent="#accordionEx">
                              <div class="card-body">
                               There may be minor irritation in your gums while you are getting accustomed to your new dentures. But once you are habituated, it is a totally painless process.
                              </div>
                            </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="offset-lg-4 col-lg-4">
                            <iframe width="100%" height="315" src="https://www.youtube.com/embed/ZX019KlDtaY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                        <!-- <div class="col-lg-4">
