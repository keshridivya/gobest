...
<link rel="shortcut icon" href="wp-content/themes/clove/images/favicon.png" type="image/x-icon">
	<title>Tooth-Extraction - Gobest Dentist	</title>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="root-info py-3">
                            <h5 style="font-family: Anton, sans-serif;" class="mb-3">TOOTH EXTRACTION TREATMENT</h5>
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3"> ‘If the dentist at GoBest Dentist are asking you for extraction, trust us it is the last resort.’</h2>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-7">
                        <div class="root-info py-4">
                            ...
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3"> When do I require my teeth to get extracted?</h2>
                            ...
                            <ul class="list-style">
                                ...
                                <li><i class="fa fa-plus"></i> Impacted wisdom teeth.</li>
                    ...
                    <div class="col-lg-5 pr-xl-0">
                        <div class="root-img">
                            <img src="images/treatment/extraction1.png" alt="Extraction" class="img-fluid">
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-5 root-order">
                        <div class="root-img pb-5">
                            <img src="images/treatment/extraction2.png" alt="Extraction" class="img-fluid">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-7">
                        <div class="root-info py-5">
                            ...
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3"> What are the types of tooth extraction</h2>
                            <p style="font-size:16px; line-height: 200%;">The type of method used for tooth extraction depends on the amount of grip available for a dentist to hold and remove the tooth.</p>
                            <p style="font-size:16px; line-height: 200%;"><b> SIMPLE EXTRACTION</b><br>
                            If your tooth is completely visible and easily accessible, we might choose a simple extraction procedure for you. We will give local anesthesia to numb the concerned area so that you do not feel any pain during the procedure. You might feel a little pressure and that is totally normal.</p>
                            <p style="font-size:16px; line-height: 200%;" class="moretext">In case of simple extraction, we may require simple instruments like elevators and forceps. Elevators are used to gently rock the tooth in order to make it mobile in the socket. This will ensure an easy removal. Forceps are then used to catch the tooth and gently remove them entirely from your mouth.<br>
                            In most cases, simple extraction does not require sutures but this is not a thumb rule. Also in some cases the teeth may break into small pieces during the process of removal. In such a case, a simple tooth extraction may turn into a surgical one.</p>
                            <a class="moreless-button" href="javascript:void()">Read more</a>
                            <br><br>

                            <p style="font-size:16px; line-height: 200%;"> <b>SURGICAL EXTRACTION</b><br>
                            There are some tooth which are a little complicated in terms of removal. Such teeth requires certain additional steps then the one mentioned in simple extraction procedure.<br>
                            When the tooth is not easily accessible, we may require to make a small incision into your gum tissue before applying elevators or forceps to them. If the bone is deeply embedded into the bone, we may need to trim a little bone to reach to the tooth and cut your tooth into pieces to ensure complete removal.<br>
                             ...
                             <ul class="list-style moretext1">
                                <li style="margin-left: 0;">The following conditions may require a surgical extraction:</li><br>
                                 
                            <li><i class="fa fa-plus"></i> <b>Broken tooth</b><br>
                                Sometimes only a small portion of your tooth is visible in the oral cavity. This might be difficult for us to grasp the fragment with the instrument and remove it.</li><br>

                            <li><i class="fa fa-plus"></i><b> Brittle tooth</b><br>

                           Dental caries can weaken the tooth structure and make it brittle. Such teeth might seem to be intact but they tend to break when we try to hold them with the instrument. This might also happen in case of a traumatized tooth which might contain invisible fractures.</li><br>

                            <li><i class="fa fa-plus"></i> <b>Extremely curved tooth root</b><br>
                            Some teeth may have excessive curvatures in the root portion. Trying to forcefully remove them without making proper excess may lead to fracture of jaw bone.</li><br>

                            <li><i class="fa fa-plus"></i> <b>Impacted tooth</b><br>

                            Sometimes a tooth may be so deeply embedded under the soft tissue or bone that it is impossible for it to get erupted up to its normal occlusal level.</li><br>
                            <li>All of the above mentioned cases are easily removed by adding small steps to a simple extraction procedure.</li>
                             </ul>
                ...
                <div class="dental root">
                  <div class="container">
                    ...
                    <h2 style="font-family: Anton, sans-serif;" class="mb-3">STEPS</h2>
                    <p style="line-height: 200%;">What are the steps involved in a tooth extraction?</p>
                   
                    <div class="row">
                      <div class="col-lg-7">
                        <div class="root-info">
                            <h3 style="width:100%; font-family: Anton,sans-serif;">STEP 1: Numbing the concerned area</h3>
                            <h3 style="width:100%; font-family: Anton,sans-serif;">STEP 2: Loosening the tooth</h3>
                            <h3 style="width:100%; font-family: Anton,sans-serif;">STEP 3: Removal of tooth</h3>
                            <h3 style="width:100%; font-family: Anton,sans-serif;">STEP 4: Controlling bleeding by placing a gauze pack</h3>
                            <h3 style="width:100%; font-family: Anton,sans-serif;">STEP 5: Post-operative instructions</h3>

                           
                            <!-- <a href="javascript:void()" class="btn mt-3">BOOK AN APPOINTMENT </a> -->
                      ...
                      <div class="col-lg-5">
                        <div class="pt-2">
                            <img src="images/treatment/extraction3.png" alt="Extraction" class="img-fluid">
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="root-info py-5">
                            ...
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3"> How to prepare for a tooth extraction?</h2>
                            <p style="font-size:16px; line-height: 200%;">There are some medications and medical conditions which might adversely affect your extraction procedure. So be sure to inform us regarding all your diseases and medications even if they are over the counter.</p>
                            
                                <ul class="list-style moretext2">
                                    <li style="margin-left: 0;">The following condition may warrant a consent or change in medications before the extraction procedure:</li><br>
                                    <li><i class="fa fa-plus"></i> Bisphosphonate therapy</li>
                                    <li><i class="fa fa-plus"></i> Congenital heart disease</li>
                                    <li><i class="fa fa-plus"></i> Diabetes</li>
                                    <li><i class="fa fa-plus"></i> Liver disease</li>
                                    <li><i class="fa fa-plus"></i> Thyroid disease</li>
                                    <li><i class="fa fa-plus"></i> Damage in valves of heart</li>
                                    <li><i class="fa fa-plus"></i> Impaired immunity</li>
                                    <li><i class="fa fa-plus"></i> Any type of cancer</li>
                                    <li><i class="fa fa-plus"></i> Anti-coagulant medications</li>
                                    <li><i class="fa fa-plus"></i> Drug allergy</li>
                                    <li><i class="fa fa-plus"></i> History of Bacterial Endocarditis</li>
                                </ul>
                        ...
                        <div class="accordion md-accordion" id="accordionEx" role="tablist" aria-multiselectable="true">
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingOne1">
                              <a data-toggle="collapse" data-parent="#accordionEx" href="#collapseOne1" aria-expanded="true"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                   What is the recovery period after the extraction of tooth? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                            ...
                            <div id="collapseOne1" class="collapse show" role="tabpanel" aria-labelledby="headingOne1"
                              ...
                              <div class="card-body">
                                Depending on the type of extraction, it may take around 7 days to 3 weeks to heal the area. In case of surgical extraction it is not uncommon for healing to take as long as 6 weeks and it is completely normal. The time taken for the indentation to completely go away might be as long as 2-3 months.
                              </div>
                            </div>
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingTwo2">
                              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseTwo2"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                   Does tooth extraction hurt? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                            ...
                            <div id="collapseTwo2" class="collapse" role="tabpanel" aria-labelledby="headingTwo2"
                              data-parent="#accordionEx">
                              <div class="card-body">
                               The entire process will be carried out only after giving local anesthesia which means you won’t feel any pain during the procedure. There might be some amount of pain after the procedure when the effect of anesthesia wards off. This can be easily managed by the drugs prescribed by us and proper post-operative care.
                              </div>
                            </div>
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingThree3">
                              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseThree3"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                   What are the Do’s after tooth extraction? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                            ...
                            <div id="collapseThree3" class="collapse" role="tabpanel" aria-labelledby="headingThree3"
                              ...
                              <div class="card-body">
                                <ul class="list-style">
                                    <li><i class="fa fa-plus"></i> Keep the gauze pack into place for atleast 45 minutes to 1 hour to ensure proper clot formation.</li>
                                    <li><i class="fa fa-plus"></i> Take proper rest.</li>
                                    <li><i class="fa fa-plus"></i> Stay hydrated.</li>
                                    <li><i class="fa fa-plus"></i> Only eat soft and cold food for 24 hours.</li>
                                    <li><i class="fa fa-plus"></i> Use an ice pack on outside of your face to reduce swelling.</li>
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingThree4">
                              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseThree4"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                   What are the Don’ts after tooth extraction? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                            ...
                            <div id="collapseThree4" class="collapse" role="tabpanel" aria-labelledby="headingThree4"
                              ...
                              <div class="card-body">
                                <ul class="list-style">
                                    <li><i class="fa fa-plus"></i> Do not spit for the first 24 hours.</li>
                                    <li><i class="fa fa-plus"></i> Avoid any activity that might produce suction in the mouth. This might dislodge the clot.</li>
                                    <li><i class="fa fa-plus"></i> Refrain from smoking and drinking.</li>
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingThree5">
                              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseThree5"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                    When to see a doctor? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                            ...
                            <div id="collapseThree5" class="collapse" role="tabpanel" aria-labelledby="headingThree5"
                              ...
                              <div class="card-body">
                                <ul class="list-style">
                                    <li><i class="fa fa-plus"></i> Pus discharge</li>
                                    <li><i class="fa fa-plus"></i> Very heavy bleeding</li>
                                    <li><i class="fa fa-plus"></i> Tingling sensation</li>
                                    <li><i class="fa fa-plus"></i> Fever or other signs of infections</li>
                                    <li><i class="fa fa-plus"></i> Severe swelling that has started 3 days after surgery.</li>
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingThree6">
                              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseThree6"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                   What are the options for replacement of tooth after removal? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="offset-lg-4 col-lg-4">
                            <iframe width="100%" height="315" src="https://www.youtube.com/embed/rmHOLLv37a0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                        <!-- <div class="col-lg-4">
