...
<link rel="shortcut icon" href="wp-content/themes/clove/images/favicon.png" type="image/x-icon">
	<title>Root-Cannal-Treatment - Gobest Dentist	</title>
...
<div class="row">
                    <div class="col-lg-12">
                        <div class="root-info py-4">
                            ...
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3"> What is a Root Canal treatment?</h2>
                            <p style="font-size:16px; line-height: 200%;">It is a process of removing dead pulp tissue and replacing it with an inert material after thorough cleansing of tooth. Pulp is the centre of your tooth which is the home to its nerve and blood supply.</p>
                            <p style="font-size:16px; line-height: 200%;" class="moretext">Root canal therapy is a series of procedures used to address issues with the soft pulp tissue of the tooth, which includes nerves and blood vessels. While some people wrongly believe it is a painful operation, it is usually no more painful than a filling. It is, in reality, one of the most effective treatments for toothaches.<br><br>
                            When the pulp tissue of a tooth becomes infected or inflamed, root canal treatment is needed. Pulp tissue is made up of blood vessels, connective tissue, and nerve cells. That is the reason why a problem here can be so painful. The pain can fade away with time, at least temporarily. However, without treatment, the infection can transform into an abscess and can even lead to systemic health problems which are occasionally reported to be fatal.</p>
      ...
      <div class="row">
                    <div class="col-lg-5 root-order">
                        <div class="root-img pb-5">
                            <img src="images/treatment/root-canal-1.png" alt="Root Canal" class="img-fluid">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-7">
                        <div class="root-info py-5">
                            ...
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3"> When do you need a Root Canal?</h2>
                            <p style="font-size:16px; line-height: 200%;">You might need a root canal if you have any of the following symptoms:</p>
                            <ul class="list-style">
                                <li><i class="fa fa-plus"></i> Severe tooth pain.</li>
                                <li><i class="fa fa-plus"></i> Prolonged sensitivity.</li>
                                <li><i class="fa fa-plus"></i> Tooth discolouration.</li>
            ...
            <div class="dental root">
                  <div class="container"  >
                    ...
                    <h2 style="font-family: Anton, sans-serif;" class="mb-3">WHY</h2>
                    <p style="line-height: 200%;"> Following are the reasons to get a root canal treatment: </p>
                    <p style="line-height: 200%;">You may need a<strong> root canal treatment</strong> to address:</p>
                    <div class="row">
                      <div class="col-lg-7">
                        <div class="root-info">
                            <!-- <h5 class="mb-3">WHY</h5> -->
                            
                            <h3 style="width:100%; font-family: Anton,sans-serif;">An abscess.</h3>
                            <h3 style="width:100%; font-family: Anton,sans-serif;">A cavity that has reached tooth pulp.</h3>
                            <h3 style="width:100%; font-family: Anton,sans-serif;">Severing of tooth nerve due to trauma.</h3>
                            <h3 style="width:100%; font-family: Anton,sans-serif;">A tooth fracture</h3>
                            <h3 style="width:100%; font-family: Anton,sans-serif;"> Inflammation of tooth nerve due to repeated dental procedures.</h3><br>
                            <p style="line-height: 200%;">We recommend you to make an appointment for full evaluation of Root Canal.</p>
                            <a href="javascript:void()" onclick="openNav()" class="btn mt-3 toggle1 display">BOOK AN APPOINTMENT </a>
                      ...
                      <div class="col-lg-5">
                        <div class="pt-2">
                            <img src="images/treatment/root-canal-2.png" alt="Root Canal" class="img-fluid">
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="container" >
                <div class="row">
                    <div class="col-lg-5 root-order">
                        <div class="root-img pb-5">
                            <img src="images/treatment/root-canal-3.png" alt="Root Canal" class="img-fluid">
                        </div>
                    </div>
                    <div class="col-lg-7">
                        <div class="root-info py-5">
                            <h5 style="font-family: Anton, sans-serif;" class="mb-3">HOW</h5>
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3"> How is root canal treatment done?</h2>
                            <p style="font-size:16px; line-height: 200%;">The root canal treatment process usually begins in the same way as a filling and without major discomfort: local anesthesia is given to numb the tooth and the area around it. </p>
                            <ul class="list-style moretext1">
                                <!-- <li><i class="fa fa-plus"></i> </li> -->
                                <li><i class="fa fa-plus"></i> Then, a small opening is made in the surface of the affected tooth in order to reach the pulp cavity and root canals. Tiny instruments, sometimes with the aid of a microscope, are used to remove the dead pulp tissue from the narrow canals of your tooth. The cavity and empty channels are cleaned, disinfected and prepared to receive the filling made of inert and biocompatible material. Finally, adhesive cement is used to seal the opening of the tooth, thus preventing future infections.</li>
                                <li><i class="fa fa-plus"></i> After root canal treatment, your tooth may be slightly tender or sore for a few days. Over-the-counter pain relievers such as ibuprofen are effective in relieving discomfort, but prescription medications can be given if necessary. During this period, it is probably best to avoid biting hard on the affected tooth. However, all these symptoms should be temporary.</li>
                                <li><i class="fa fa-plus"></i> In order for the tooth to be more protected and to fully recover, in general, a crown or other type of restoration is needed. The restoration can be done in several ways: with traditional gold crowns or with dental replicas made of high-tech tooth-colored material. In all cases, you will have made an investment in maintaining your dental health in the future.</li>
                            </ul>
                            ...
                            <div class="card-header" role="tab" id="headingOne1">
                              <a data-toggle="collapse" data-parent="#accordionEx" href="#collapseOne1" aria-expanded="true"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                   Do I need a root canal if I don’t have pain? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                            <!-- Card body -->
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingTwo2">
                              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseTwo2"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                   What are my other treatment choices? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingThree3">
                              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseThree3"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                   Will I have discomfort after the procedure is done? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingThree4">
                              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseThree4"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                   Is there anything I can do to avoid the need for future root canals? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingThree5">
                              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseThree5"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                    Aren’t Root Canals Prone to Failure? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingThree6">
                              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseThree6"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                   Why do I need a dental crown after getting a Root Canal treatment?<i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
