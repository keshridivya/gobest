...
<link rel="shortcut icon" href="wp-content/themes/clove/images/favicon.png" type="image/x-icon">
	<title>Cosmetic Dentist - Gobest Dentist	</title>
...
<section class="root">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="root-info py-3">
                            <h5 style="font-family: Anton, sans-serif;" class="mb-3">COSMETIC DENTISTRY TREATMENT</h5>
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3"> ‘Boost your confidence by perfecting your smile with us!’</h2>
                            <p style="font-size:16px; line-height: 200%;">Are you disappointed with your smile? Do you feel conscious while posing for a selfie? We have variety of options available to enhance the appeal of your smile!</p>     
                            <p style="font-size:16px; line-height: 200%;">Learn about our most popular cosmetic dentistry services.</p>
                            <!-- <a href="javascript:void()" class="btn mt-3">VISIT GOBEST DENTIST TODAY</a>  -->
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-5 root-order">
                        <div class="root-img pb-5">
                            <img src="images/treatment/Cosmetic-Dentistry1.png" alt="Cosmetic Dentistry" class="img-fluid">
                        </div>
                    ...
                    <div class="col-lg-7">
                        <div class="root-info py-4">
                            ...
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3"> Who needs a cosmetic dental makeover?</h2>
                            <p style="font-size:16px; line-height: 200%;">You might need a cosmetic dentistry makeover if you have any of the following teeth or gum issues:
                                </p>
                                <ul class="list-style">
                                    <li><i class="fa fa-plus"></i> Stained or discoloured teeth</li>
                                    <li><i class="fa fa-plus"></i> Worn out teeth</li>
                                    <li><i class="fa fa-plus"></i> Chipped or broken teeth</li>
                                    <li><i class="fa fa-plus"></i> Misaligned teeth</li>
                                    <li><i class="fa fa-plus"></i> Improper shape of teeth</li>
                                    <li><i class="fa fa-plus"></i> Gaps between the teeth</li>
                                </ul> 
                                <p style="font-size:16px; line-height: 200%;">You may need a cosmetic dentistry treatment if you have any of the following:</p>
                                    <ul class="list-style moretext">
                                        <li><i class="fa fa-plus"></i> You feel embarrassed due to your teeth or cannot open up while speaking in front of others<br>
                                        Are you having a missing, misaligned or discoloured teeth which is visible when you smile? Then it is very natural for you to feel less confident while greeting other people. This can eventually lead to a feeling of loneliness and depression. As a cosmetic dentist, we have all the ways to boost up your confidence.</li>
                                        <li><i class="fa fa-plus"></i> You are recently suffering from digestive issues that you never had before<br>
                                        One of the most important functions of teeth is its role in chewing and digestion of food. Missing teeth can affect your ability to properly break the food bolus into pieces and can cause digestive problems like acid reflux, gastric ulcers as well as heart burn.</li>
                                        <li><i class="fa fa-plus"></i> You are noticing that the shape of your face is different than before<br>
                                        Have you ever noticed that teeth tend to move in the direction of empty space? This will not only change the orientation of your oral musculature but also change the pattern of your jaw bone structure. Sounds complicated isn’t it? Leave it to us, we will choose the best for you.</li>
                                    </ul>
                                ...
                                <p style="font-size:16px; line-height: 200%;">Want to improve your smile?</p>
                ...
                <!-- <div class="row">
                    <div class="col-lg-5 root-order">
                        <div class="root-img">
                            <img src="image/treatment/Cosmetic-Dentistry2.png" alt="Cosmetic Dentistry" class="img-fluid">
                    ...
                    <div class="col-lg-7">
                        <div class="root-info py-5">
                            ...
                            <h2 class="mb-3"> What are the treatments included in cosmetic dentistry?</h2>
                            <p>You will need a dental crown/bridge if you have:</p>
                            <ul class="list-style">
                                <li><i class="fa fa-plus"></i> A Grossly decayed tooth while cannot be saved by solely filling it or making an <a href="javascript:void()"> inlay/onlay</a>.</li>
                                ...
                                <li><i class="fa fa-plus"></i> As a final step of<a href="dental-implant-treatment.php"> Dental Implant procedures</a> to replace a missing tooth.</li>
                            </ul>
                            <p>Looking for replacement options that looks exactly like your natural teeth?</p>
                ...
                <div class="dental root">
                  <div class="container">
                    ...
                    <h2 style="font-family: Anton, sans-serif;" class="mb-3"> What are the treatments included in cosmetic dentistry?</h2>
                    <div class="row">
                      <div class="col-lg-7">
                        <div class="root-info">
                            <h3 style="width:100%; font-family: Anton,sans-serif;">Veneers</h3>
                            <h3 style="width:100%; font-family: Anton,sans-serif;">Crowns</h3>
                            <h3 style="width:100%; font-family: Anton,sans-serif;">Enamel shaping</h3>
                            <h3 style="width:100%; font-family: Anton,sans-serif;">Orthodontics</h3>
                            <h3 style="width:100%; font-family: Anton,sans-serif;">Teeth whitening</h3>
                            <h3 style="width:100%; font-family: Anton,sans-serif;">Composite filling</h3>
                            <h3 style="width:100%; font-family: Anton,sans-serif;">Gum reshaping</h3>
                      ...
                      <div class="col-lg-5">
                        <div class="pt-2">
                            <img src="images/treatment/Cosmetic-Dentistry2.png" alt="Cosmetic-Dentistry" class="img-fluid">
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <section class="root">
              <div class="container">
                <div class="row">
                    <div class="col-lg-5 root-order">
                        <div class="root-img">
                            <img src="images/treatment/Cosmetic-Dentistry3.png" alt="Cosmetic-Dentistry" class="img-fluid">
                        </div>
                    </div>
                    <div class="col-lg-7">
                        <div class="root-info py-5">
                            <!-- <h5 class="mb-3">PROCESS</h5> -->
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3"> Veneers</h2>
                            <p style="font-size:16px; line-height: 200%;">How to improvise in a short time? Place veneers. Veneers can be selected in types of cases such as:</p>
                            <ul class="list-style">
                                <li><i class="fa fa-plus"></i>  Darkening of the enamel, not susceptible to bleaching;</li>
                                <li><i class="fa fa-plus"></i> Cracked and chipped teeth;</li>
                                <li><i class="fa fa-plus"></i> Non-carious enamel lesions: fluorosis, "tetracycline teeth";</li>
                                <li><i class="fa fa-plus"></i> Improper shape and position of the teeth.</li>
                                
                            </ul>
                           <p style="font-size:16px; line-height: 200%;" class="moretext1">There are the following types of dental restoration with veneers: direct (in the patient's mouth) and indirect (in the laboratory). An indirect restoration is more aesthetically pleasing and natural. Composite, zirconium or ceramic veneers can be used for it. The cost of zirconium and ceramic veneers is usually higher, but they also last longer and are significantly more aesthetically pleasing than composite veneers.</p>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="root-info py-4">
                    ...
                    <h2 style="font-family: Anton, sans-serif;" class="mb-3"> Crowns</h2>
                    <p style="font-size:16px; line-height: 200%;">A dental crown which is commonly known as ‘cap’ is placed over teeth which are damaged due to caries or other dental anomalies. They can also be used to improve the shape, size, appearance and strength of the teeth. These crowns can last from five to fifteen years to almost lifetime for some patients. They can be either made up of metal, porcelain fused to metal or it can be a resin or ceramic.</p>
                    
                    <!-- <a href="javascript:void()" class=" mt-3">Click to know more</a> -->
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="root-info py-4">
                <!-- <h5 class="mb-3">WHAT</h5> -->
                <h2 style="font-family: Anton, sans-serif;" class="mb-3"> Enamel shaping</h2>
                <p style="font-size:16px; line-height: 200%;">Enamel shaping is a simple non-surgical dental procedure that can help improve the appearance of your smile. Enamel is the outermost layer of your teeth. The process of enamel shaping includes physically shaping this layer to correct uneven or overlapped teeth.</p>
                <p style="font-size:16px; line-height: 200%;" class="moretext2">Only small amount of the tooth layer is removed either using fine diamond burs or sandpaper strips. Since the amount of enamel removed is very small, you will not feel any pain during the procedure and thus will not require an anaesthetic shot. After the completion of shaping process, a final polishing procedure will be performed which will give a natural finish to your teeth and smoothen any sharp edges.<br><br>
                <a href="javascript:void()" class="toggle1 display"> GET AN APPOINTMENT</a> to know whether Enamel shaping is a right option for your teeth.
            </p>
...
<br><br>
        ...
        <div class="row">
         ...
         <div class="row">
            <div class="col-lg-12">
                <div class="root-info py-4">
                <h2 style="font-family: Anton, sans-serif;" class="mb-3"> Composite filling</h2>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="root-info py-4">
                <h2 style="font-family: Anton, sans-serif;" class="mb-3"> Gum reshaping</h2>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="offset-lg-4 col-lg-4">
                           <iframe width="100%" height="315" src="https://www.youtube.com/embed/iJTtbKhdfHY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                        </div>
                    </div>
            </section>
