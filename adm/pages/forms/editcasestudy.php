...
if(isset($_GET['id'])){
  ...
  $name=$result['title'];
  $degree=$result['shortdesc'];
  $description=$result['detaildesc'];
  $image=$result['banner'];
}
   ...
   if (isset($_POST['submit'])){
	   $name=mysqli_real_escape_string($conn,$_POST['Name']);
        ...
        $id=intval($_GET['id']);
        $sql=mysqli_query($conn,"update casestudy set title='$name' where id='$id'");
        if($sql){
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
		...
		<div class="form-group">
		  <img src="caseimage/<?php echo $image ?>" style="border:1px solid black; width:100px; height:100px"><br><a href="changecaseimage.php?action=edit&id=<?php echo $result['id']; ?>" class="btn btn-success mt-2">Change Image</a>
		</div>
