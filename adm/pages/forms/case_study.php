        ...
        <div class="card">
          <div class="card-body">
            <form id="blogForm" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                <textarea id="detailDesc" name="detailDesc" required></textarea>
              </div>-->
              <div class="form-group">
                <input type="file" name="imgBanner" id="imgBanner" required>
                <input type="hidden" name="bannerImg" id="bannerImg">
              </div>
             <!-- <div class="form-group">
                <input type="text" class="form-control" placeholder="Meta Title" name="metaTitle" id="metaTitle" required>
              </div>
              <div class="form-group">
                <input type="text" class="form-control" placeholder="Meta Description" name="metadesc" id="metadesc" required>
              </div>-->
              <div class="row">
                <!-- /.col -->
                <div class="col-4">
