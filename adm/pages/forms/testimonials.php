        ...
        <div class="row mb-2">
          ...
          <td><?php echo $row["id"]; ?></td>
					...
					<td>
						<table>
							<tbody>
								<tr>
						<td class="p-2">
						<!--<a href="#" class="btn btn-info btn-xs" data-toggle="modal" data-target="#purchase_edit" data-tt="tooltip" title="" data-purchase_id="15" data-original-title="Edit purchase">
            ...
            <a href="?action=delete&id=<?php echo $row["id"]; ?>" title="" class="btn btn-danger btn-xs delete_purchase">
		                       ...
		                       <!-- <a href="?action=delete&id=<?php echo $row["id"]; ?>" data-toggle="modal" data-target="#delete_purchase" data-tt="tooltip" title="" class="btn btn-danger btn-xs delete_purchase" data-purchase_id="15" data-original-title="Delete purchase">
		                          <i class="fas fa-trash"></i>
		                        </a>-->
						</td>
						</tr>
