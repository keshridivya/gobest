  ...
  <div class="col-lg-3 col-md-6 col-sm-6">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-doctor-box flip-card">
                            <div class="flip-card-inner">
                                <div class="flip-card-front">
                                    <img src="assets/img/doctors/ashwini.jpg" class="img-fluid" alt="dental clinic in pimpri chinchwad">
                                    <div class="content">
                                        <h3>Dr. Ashwini P</h3>
                                        <span>Head dentist : Wakad Branch</span>
                                        <p>Dr. Ashwini P is highly experienced doctor and excels in aesthetic(cosmetic), extractions and prosthesis </p>
                                        <a href="javascript:void(0)" class="hover-me">Read More ></a>
                                    </div>
                                </div>
                                <div class="flip-card-back">
                                    <p>Dr. Ashwini P is a graduate in dental surgery from the well renowned Late Shri Yashwantrao Chavan Memorial & Rural Development Foundation's Dental College, Ahmednagar.</p>
                                    <p>She is highly experienced doctor and excels in aesthetic (cosmetic) , endodontistry (root canals), extractions and prosthesis ( replacement of missing teeth).</p>
                                    <p>Along with routine treatments like root canal, cap-bridge, extractions, she has expertise in microendo ,she  has completed microendo course and latest dental treatment like everstik fiber splinting and replacement of single tooth by using everstik fiber and composite .. Maryland bridge post and core using fiber post, minor surgery's like frenectomy ,Smile desining ,Esthetic restoration.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-doctor-box flip-card">
                            <div class="flip-card-inner">
                                <div class="flip-card-front">
                                    <img src="assets/img/doctors/ayushi.jpg" class="img-fluid" alt="dentist in nigdi">
                                    <div class="content">
                                        <h3>Dr. Ayushi W</h3>
                                        <span>Head Dentist - Akurdi Branch (Morning Session)</span>
                                        <p>Dr. Ayushi W is having experience in Aesthitic (Cosmetics),Endodontistry (Root Canal)</p>
                                        <a href="javascript:void(0)" class="hover-me">Read More ></a>
                                    </div>
                                </div>
                                <div class="flip-card-back">
                                    <p>Dr.Ayushi W is Graduate in Dental surgery from well known Modern Dental College and Research center Indore.</p>
                                    <p>She is having experience in Aesthitic (Cosmetics), Endodontistry (Root Canal), Teeth extractions and prosthesis (Replacement of missing tooth).</p>
                                    <p>She is well versatile alongwith  routine treatments like, Root Canal, Cap bridge, extractions.</p>
                                    <p>She is having specialisation and expertise in advance Dental treatments like Splinting,Crown lengthening,Post and Core . Advanced surgery etc.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-doctor-box flip-card">
                            <div class="flip-card-inner">
                                <div class="flip-card-front">
                                    <img src="assets/img/doctors/laxmi.jpg" class="img-fluid" alt="best dental clinic in pune">
                                    <div class="content">
                                        <h3>Dr. Laxmi U</h3>
                                        <span>Head Dentist - Akurdi Branch (Evening Session)</span>
                                        <p>Dr. Laxmi U is highly experienced doctor and excels in aesthetic (cosmetic), gummy smile</p>
                                        <a href="javascript:void(0)" class="hover-me">Read More ></a>
                                    </div>
                                </div>
                                <div class="flip-card-back">
                                    <p>Dr. Laxmi U is a graduate in dental surgery from the well renowned Annasaheb Chudaman Patil Memorial Dental College Dhule</p>
                                    <p>She is highly experienced doctor and excels in aesthetic (cosmetic) , gummy smile, spacing in front teeth, endodontistry (root canals), wisdom tooth extractions and prosthesis ( replacement of missing teeth).</p>
                                    <p>Along with routine treatments like root canal, cap-bridge, extractions,  and latest dental treatment like   splinting and  post and core using fiber post, minor surgeries like frenectomy ,Smile designing ,Esthetic restoration (correct spacing) also did her workshop in medical emergency Management.</p>
                                </div>
                            </div>
                        </div>
                    </div>
