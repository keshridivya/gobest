...
<link rel="shortcut icon" href="wp-content/themes/clove/images/favicon.png" type="image/x-icon">
	<title>Dental-Cavity-Fillings - Gobest Dentist	</title>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="root-info py-3">
                            <h5 style="font-family: Anton, sans-serif;" class="mb-3">DENTAL FILLINGS</h5>
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3"> ‘Long-lasting fillings with optimal materials: We pay attention to aesthetics, durability and compatibility!’</h2>
                        </div>
                    </div>

                     <div class="col-lg-5 root-order">
                        <div class="root-img">
                            <img src="images/treatment/cavity1.png" alt="Dental Fillings">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="root">
            <div class="container">
                <div class="row">
                    <div class="col-lg-5 root-order">
                        <div class="root-img">
                            <img src="images/treatment/cavity2.png" alt="Dental Fillings" class="img-fluid">
                        </div>
                    ...
                    <div class="col-lg-7">
                        <div class="root-info py-4">
                            ...
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3"> What are dental fillings?</h2>
                            <p style="font-size:16px; line-height: 200%;">Tooth fillings describe the replacement of hard tooth substance. The loss of the hard tooth substance is mostly caused by caries, but it can also be caused by a tooth fracture. The hard tooth substance is replaced by plastic filling material such as plastic (composites), compomers and glass ionomer cements or by inlay fillings in the form of gold or ceramic.</p>
        ...
        <section class="root">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="root-info py-5">
                            ...
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3"> Plastic fillings</h2>
                            <p style="font-size:16px; line-height: 200%;">When talking about plastic fillings, from a dental point of view, fillings with composite are meant. Composite consists of over 50% fillers (silicates, sands) that are held together by a resin.</p>
                            <p style="font-size:16px; line-height: 200%;" class="moretext">The composite we use is hardened in a complex multi-layer process. This means that the smallest amounts of composites are stuffed into the tooth cavity (cavity) and hardened with a blue light lamp. The composite material is thus introduced into the tooth cavity using a dentine adhesive, i.e. it forms a bond with the tooth. Although this procedure is time-consuming, it delivers optimal results. The durability of composite fillings is very good if they are carefully processed - we made fillings myself over ten years ago (at the beginning of our clinic) that are still intact today.</p>
                    ...
                    <div class="col-lg-5 root-order">
                        <div class="root-img pb-5">
                            <img src="images/treatment/cavity3.png" alt="Dental Fillings" class="img-fluid">
                ...
                <div class="row">
                    <!-- <div class="col-lg-5 root-order">
                        <div class="root-img">
                            <img src="image/treatment/Dental-care-and-hygiene3.png" alt="Dental Care and Hygine" class="img-fluid">
                        </div>
                    </div> -->
                    <div class="col-lg-12">
                        <div class="root-info py-5">
                           ...
                           <p style="font-size:16px; line-height: 200%;">In addition to classic tooth fillings, high-quality and long-lasting inlay fillings, so-called inlays, are enjoying increasing popularity - especially ceramic inlays.</p>
                            <li><i class="fa fa-plus"></i> A ceramic inlay has an average shelf life of ten to fifteen years or longer and is therefore superior to other forms of restoration.</li>
                            <li><i class="fa fa-plus"></i> So far, no health risks have been identified when using ceramic as an inlay material. Allergic reactions can also be almost ruled out.</li>
                            <li><i class="fa fa-plus"></i> An all-ceramic inlay meets the highest aesthetic standards. It looks completely natural and is visually indistinguishable from the tooth.</li>
                            <li><i class="fa fa-plus"></i> In contrast to many other materials, ceramic is an environmentally friendly substance and can be disposed of without any problems after its removal.</li>
                            <li><i class="fa fa-plus"></i> A ceramic inlay offers maximum stability and optimal distribution of chewing pressure. Bending or deformation of the material can be ruled out if it is properly fitted. Ceramic inlays are adhesively bonded to the remaining tooth, so even very thin tooth walls can be obtained thanks to the stabilizing function of the ceramic.</li>
                            <li><i class="fa fa-plus"></i> Each ceramic inlay is made individually by a well-trained dental technician, fits exactly into the tooth cavity and has a perfect edge fit due to the bonding with the tooth. Thanks to its individually shaped surface, the tooth inlay enables a perfect finish to the neighbouring teeth. The gap between the teeth, where tooth decay often occurs, can be closed. The stability of ceramic inlays corresponds to that of the natural tooth. The already weakened tooth is therefore not exposed to the risk of tension fractures.</li>
                        </ul>
                        ...
                        <div class="accordion md-accordion" id="accordionEx" role="tablist" aria-multiselectable="true">
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingOne1">
                              <a data-toggle="collapse" data-parent="#accordionEx" href="#collapseOne1" aria-expanded="true"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                   When is a tooth filling necessary? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                            ...
                            <div id="collapseOne1" class="collapse show" role="tabpanel" aria-labelledby="headingOne1"
                              ...
                              <div class="card-body">
                                Abroken tooth, damage from tooth decay or excessive stress on the tooth surface, for example from grinding. Whenever the protective enamel layer is no longer completely intact, the affected area must be treated with a tooth filling. The filling protects against further damage and maintains the healthy function of the teeth.
                              </div>
                            </div>
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingTwo2">
                              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseTwo2"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                  How long does a tooth filling last? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                            ...
                            <div id="collapseTwo2" class="collapse" role="tabpanel" aria-labelledby="headingTwo2"
                              data-parent="#accordionEx">
                              <div class="card-body">
                              All dental fillings are generally designed to be durable in order to avoid additional treatments. Dental cement is an exception, but is mainly used as assembly material or for temporary fillings. Used as a filler material, it has to be replaced after one to two years. Today's composite fillings in the anterior region last about four to six years. Amalgam fillings usually last seven to eight years. Ceramic inlays have a shelf life of eight to ten years. These periods of time are of course dependent on the position and size of the filling as well as thorough and regular dental care like <a href="/dental-treatments/teeth-scaling-polishing-in-pune.php"> scaling</a>.
                              </div>
                            </div>
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingThree3">
                              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseThree3"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                   What should be considered after the treatment? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                            ...
                            <div id="collapseThree3" class="collapse" role="tabpanel" aria-labelledby="headingThree3"
                              data-parent="#accordionEx">
                              <div class="card-body">
                                The dentist gives precise guidelines as to when the treated tooth can be used again. Very hot and very cold food and drinks should be avoided at first. Persistent pain after treatment may indicate a loosened or displaced filling. Under these circumstancesthe dentist should be visited so that he can eliminate the cause of the discomfort.
                              </div>
                            </div>
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingThree3">
                              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseThree3"
                                aria-expanded="false" aria-controls="collapseThree3">
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                  What are possible problems and side effects of a tooth filling? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                            ...
                            <div id="collapseThree3" class="collapse" role="tabpanel" aria-labelledby="headingThree3"
                              data-parent="#accordionEx">
                              <div class="card-body">
                                With all filling materials, with the exception of dental gold, allergic reactions can occur in rare cases. A change of the filling material then usually brings improvement. As with any dental treatment, there remains a certain risk of pain or an increased sensitivity to cold, heat or pressure. Usually these complaints subside by themselves after a while. If problems persist, a further appointment should be made. Tooth fillings can become cracked or porous over the years. However, the mandatory check-ups at the dentist are usually sufficient to initiate a timely renewal.
                              </div>
                            </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="offset-lg-4 col-lg-4">
                            <iframe width="100%" height="315" src="https://www.youtube.com/embed/9kp23fjJQmk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                        <!-- <div class="col-lg-4">
