...
<link rel="shortcut icon" href="wp-content/themes/clove/images/favicon.png" type="image/x-icon">
	<title>Crown-and-Bridges - Gobest Dentist	</title>
  ...
  <section class="root">
             <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="root-info py-3">
                            <h5 style="font-family: Anton, sans-serif;" class="mb-3">DENTAL CROWN TREATMENT</h5>
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3"> ‘Bring back the integrity of your smile with us’</h2>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-5 root-order">
                        <div class="root-img pb-5">
                            <img src="images/treatment/crown1.png" alt="Dental Crown" class="img-fluid">
                        </div>
                ...
                <div class="row">
                   <!--  <div class="col-lg-5 root-order">
                        <div class="root-img">
                            <img src="image/treatment/dental-crown1.jpg" alt="Dental Crown" class="img-fluid">
                    ...
                    <div class="col-lg-12">
                        <div class="root-info py-5">
                            ...
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3"> When do you need a Dental Crown?</h2>
                            <p style="font-size:16px; line-height: 200%;">You will need a dental crown/bridge if you have:</p>
                            <ul class="list-style">
                                ...
                                <li><i class="fa fa-plus"></i> A Grossly decayed tooth while cannot be saved by solely filling it or making an inlay/onlay.</li>
            ...
            <div class="dental root">
                  <div class="container">
                    ...
                    <h2 style="font-family: Anton, sans-serif;" class="mb-3">TYPES</h2>
                    <p style="line-height: 200%;">What are the types of Dental crown?</p>
                    <p style="line-height: 200%;">There are a variety of options available at GoBest Dentist for you to choose from. This includes:</p>
                    <div class="row">
                      <div class="col-lg-7">
                        <div class="root-info">
                            <!-- <h5 class="mb-3">WHY</h5> -->
                            <h3 style="font-family: Anton, sans-serif; width:100%;">Metal Crown</h3>
                            <h3 style="font-family: Anton, sans-serif; width:100%;">Ceramic crown</h3>
                            <h3 style="font-family: Anton, sans-serif; width:100%;">Porcelain crown</h3>
                            <h3 style="font-family: Anton, sans-serif; width:100%;">Composite resin crown</h3>
                            <h3 style="font-family: Anton, sans-serif; width:100%;">Gold crown</h3>
                            <h3 style="font-family: Anton, sans-serif; width:100%;">Combination of all materials.</h3>
                            <p style="line-height: 200%;">The choice of material for your crown depends on many factors.</p>
                            <p style="line-height: 200%;" class="moretext3"><b>1.  LOCATION:</b><br>
The location of the tooth which requires a crown plays a key role in material selection. A crown located in the front should be more aesthetically pleasing while the crown located more posteriorly should be superior in strength.<br><br>

<b>2. REMAINING TOOTH STRUCTURE:</b><br>
All the above materials require different thickness in order to provide adequate strength to bear the chewing forces. This will determine the amount of cutting required for a particular crown. Metal crown requires minimum thickness and therefore preserves maximum natural tooth. Thus, remaining tooth structure plays a crucial role in deciding the material for the crown.<br><br>

<b>3. POSITION OF YOUR GUM LINE:</b><br>
It is necessary to place the margin of your crown over healthy, sound tooth structure. Thus, the position of your gum line will help us decide which crown should will be best for you.
                            ...
                            <a class="moreless-button3" href="javascript:void()" style="text-decoration: underline;
    color: #fff;">Read to know more</a>
                            <br><br>
                            <a href="javascript:void()" class="btn mt-3 toggle1 display">BOOK AN APPOINTMENT </a>

                        </div>
                      </div>
                      <div class="col-lg-5">
                        <div class="pt-2">
                            <img src="images/treatment/crown2.png" alt="Dental Crown" class="img-fluid">
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="container">
                <div class="row">
                    <div class="col-lg-5 root-order">
                        <div class="root-img">
                            <img src="images/treatment/crown3.png" alt="Dental Crown" class="img-fluid">
                        </div>
                    </div>
                    <div class="col-lg-7">
                        <div class="root-info py-5">
                            <h5 style="font-family: Anton, sans-serif;" class="mb-3">PROCESS</h5>
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3"> Our process of creating a crown</h2>
                            <p style="font-size:16px; line-height: 200%;">It is usually a two day procedure:</p>
                            <ul class="list-style">
                                <!-- <li><i class="fa fa-plus"></i> </li> -->
                                <li><i class="fa fa-plus"></i> First visit: Examining the tooth and preparing it for crown which is followed by an impression and shade matching. Temporary crown may be cemented if needed.</li>
                                <li><i class="fa fa-plus"></i> Second visit: Minor adjustments in crown if required followed by permanent cementation.</li>
                                
                            </ul>
                           <ul class="list-style moretext1">
                               <li><i class="fa fa-plus"></i> Firstly, we will examine and prepare your tooth which requires a crown. This may include taking X-rays and mould of your teeth beforehand.</li>
                                <li><i class="fa fa-plus"></i> Your tooth will then be prepared to receive the crown. This may include trimming of its surface to the desired size and shape.</li>
                                <li><i class="fa fa-plus"></i> We will take an impression of your prepared tooth along with the adjacent teeth and gums.</li>
                                <li><i class="fa fa-plus"></i> We will put a temporary crown over the prepared tooth to ensure its protection.</li>
                                <li><i class="fa fa-plus"></i> The impression is sent to the laboratory for personalized fabrication of your crown.</li>
                                <li><i class="fa fa-plus"></i> We will cement the crown to your tooth.</li>

                           </ul>
                           <a class="moreless-button1" href="javascript:void()">Read more</a>
                            <br><br>
                            
                            <p style="font-size:16px; line-height: 200%;">‘Visit us today for best Crown and Bridge services in Pune’</p>
                            <a href="javascript:void()" onclick="openNav()" class="btn mt-3 toggle1 display">BOOK AN APPOINTMENT </a>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="root-info py-4">
                    ...
                    <h2 style="font-family: Anton, sans-serif;" class="mb-3"> Why choose GoBest Dentist for getting a crown?</h2>
                    <ul class="list-style">
                        <li><i class="fa fa-plus"></i> We use only bio-compatible materials.</li>
                        <li><i class="fa fa-plus"></i> Our crowns are durable to last for years to come.</li>
                        <li><i class="fa fa-plus"></i> We use minimally invasive techniques to ensure maximum preservation of your natural tooth.</li>
                        <li><i class="fa fa-plus"></i> Our custom crafted crowns will ensure a perfect fit and natural feel.</li>
                        <li><i class="fa fa-plus"></i> Our utmost dedication to cleanliness and safety.</li>

                    </ul>
                    
                        <p style="font-size:16px; line-height: 200%;">‘Brighten your smile with us’</p>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="root-info py-4">
                <h5 style="font-family: Anton, sans-serif;" class="mb-3">WHAT</h5>
                <h2 style="font-family: Anton, sans-serif;" class="mb-3"> What are the problems that I can expect with a dental crown?</h2>
                <p style="font-size:16px; line-height: 200%;">Dental crowns are usually as comfortable as your natural tooth. But there are some minor issues that you might face over time.</p>
                <p style="font-size:16px; line-height: 200%;"><b>1. Sensitivity of the concerned tooth</b><br>

               If your tooth is not root canal treated, it is likely that you will feel sensitivity in the prepared tooth once the anaesthesia wards off. This is temporary and will go once the crown is cemented to your tooth. Sometimes you may feel sensitivity for some days after the cementation of crown. Brushing with an anti-sensitivity tooth paste will help.<br><br>

               <b> 2. Pain on biting</b><br>
                If you feel pain while you bite normally on your crown, it usually means that the crown is high on your tooth. Don’t worry, the problem can be very easily solved once you inform us.<br><br>

                <b>3. Chipping off</b><br>
                It is common for an all porcelain crown to get chipped.  A small chip can be repaired in the mouth itself with the crown intact. A bigger chip or multiple chips may require removal of crown and re-fabrication.<br><br>

                <b>4. Loosening or removal of crown</b><br>
                Sometimes the cement used to stick the crown to the tooth might wash off or the underlying tooth might catch decay. Both the cases will lead to loosening or removal of your crown. Contact us immediately for proper guidance under such situation.<br><br>

                <b>5. Dark line on your crown near gum line</b><br>
                ...
                <p style="font-size:16px; line-height: 200%;"><strong>Want to know dental bridge cost in Pune?</strong></p>
...
<section class="faqs">
                            ...
                            <div class="card-header" role="tab" id="headingOne1">
                              <a data-toggle="collapse" data-parent="#accordionEx" href="#collapseOne1" aria-expanded="true"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                   How long does a dental crown last without problem? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingTwo2">
                              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseTwo2"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                   Are dental crowns costly? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingThree3">
                              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseThree3"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                   Does it hurt to get a crown? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
        ...
        <section class="root pb-5">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <h4 style="font-family: Anton, sans-serif;">‘We are here to address any queries related to dental crown’</h4>
                        <a href="contact-us.php" class="btn mt-3">CONTACT US TODAY</a>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="offset-lg-4 col-lg-4">
                           <iframe width="100%" height="315" src="https://www.youtube.com/embed/h96I7rtiRjc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                        </div>
                    </div>
            </section>
