...
<link rel="shortcut icon" href="wp-content/themes/clove/images/favicon.png" type="image/x-icon">
	<title>Wisdom Tooth Extraction - Gobest Dentist	</title>
            ...
            <div class="container">
                ...
                <?php include("include/treatments.php") ?>
                    ...
                    <div class="col-lg-12">
                        <div class="root-info py-3">
                            <h5 class="mb-3">WISDOM TOOTH EXTRACTION TREATMENT</h5>
                            <h2 class="mb-3"> ‘After all natural tooth is always better’</h2>
                            <p>There is no point in keeping an infection when getting a root canal is as easy as getting <a href="#.">a filling</a>.</p>
                            <p>Your comfort is our priority! Get your RCT done today.</p>
                            <a href="#." class="btn mt-3">BOOK AN APPOINTMENT </a> 
                        </div>
                    </div>-->
                </div>
                ...
                <div class="col-lg-5 root-order">
                        <div class="root-img pb-5">
                            <img src="images/treatment/wisdom-1.png" alt="wisdom tooth" class="img-fluid">
                        </div>
                    </div>
                    <div class="col-lg-7">
                        <div class="root-info py-4">
                            <h5 style="font-family: Anton, sans-serif;" class="mb-3">WHAT</h5>
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3"> What is a wisdom tooth?</h2>
                            <p style="font-size:16px; line-height: 200%;">Wisdom teeth are set of third molars that are last to erupt on each side in both upper and lower jaw. They usually erupt between the ages of 17 to 25 years.</p>
                            <p style="font-size:16px; line-height: 200%;">If your wisdom teeth does not have space to erupt in your oral cavity, it may cause pain and infection. In such cases you will have to get them pulled either by your general dentist or by your oral surgeon. Such teeth are known as impacted wisdom teeth as they are trapped inside your jaw bone or your gums.</p>
                            <!-- <p class="moretext"> If your wisdom teeth does not have space to erupt in your oral cavity, it may cause pain and infection. In such cases you will have to get them pulled either by your general dentist or by your oral surgeon. Such teeth are known as impacted wisdom teeth as they are trapped inside your jaw bone or your gums.</p>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="root-info py-5">
                            <h5 style="font-family: Anton, sans-serif;" class="mb-3">WHAT</h5>
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3"> What problem can an Impacted wisdom tooth cause?</h2>
                            <p style="font-size:16px; line-height: 200%;">Wisdom teeth might erupt normally like any other tooth in some people while some people may face repeated problems. You may have to get your wisdom teeth pulled if you have any of the following symptoms:</p>
                            <ul class="list-style">
                                <li><i class="fa fa-plus"></i> Pain.</li>
                                <li><i class="fa fa-plus"></i> Recurrent infection.</li>
                                <li><i class="fa fa-plus"></i> Bad taste in mouth.</li>
                                <li><i class="fa fa-plus"></i> Difficulty in opening mouth.</li>
                                <li><i class="fa fa-plus"></i> Decay in wisdom tooth.</li>
                                <li><i class="fa fa-plus"></i> Wisdom teeth damaging the surrounding teeth while trying to erupt.</li>
                                <li><i class="fa fa-plus"></i> Food lodgement between wisdom tooth and the adjacent tooth.</li>
                                <li><i class="fa fa-plus"></i> Food lodgement under the skin surrounding the wisdom tooth.</li>
                                <li><i class="fa fa-plus"></i> Formation of a fluid filled sac called cyst around the wisdom tooth which might require a minor surgical procedure.</li>
                                <li><i class="fa fa-plus"></i> Space issues during  orthodontic treatment of teeth.</li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="root-info py-4">
                            ...
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3"> How does wisdom tooth extraction take place?</h2>
                            <p style="font-size:16px; line-height: 200%;">Wisdom tooth extraction requires some preventive and necessary measures before it is done. First of all it is in fact necessary to carry out an x-ray of the mouth , called orthopanoramic , which will allow the doctor to identify the precise location of the tooth and decide how to operate. It is also a good idea, before and after an operation, to take an antibiotic for a few days in order to prevent risky infections.</p>
                           
                            <p style="font-size:16px; line-height: 200%;" class="moretext">This operation takes place under local anesthesia by injection. The operation consists in incising the gum, if the third molar has not come out completely, and extracting it with special surgical instruments. Once the avulsion has taken place, we proceed to give some stitches and verify that everything has been done in the right way.</p>
            ...
            <section class="root">
              <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="root-info py-5">
                            <!-- <h5 class="mb-3">HOW</h5> -->
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3"> 10 things to DO after wisdom tooth extraction</h2>
                            
                            <ul class="list-style">
                                <!-- <li><i class="fa fa-plus"></i> </li> -->
                                <li><i class="fa fa-plus"></i>Sleeping with your head elevated on a pair of pillows is an effective remedy for pain and gum bleeding after a wisdom tooth has been extracted.</li>
                                <li><i class="fa fa-plus"></i>To prevent or plug any gum bleeding, it is recommended to keep an absorbent gauze pressed on the tooth extraction site for at least 30-60 minutes, without removing it or touching it with the fingers.</li>
                                <li><i class="fa fa-plus"></i>Take prescribed medicines before the effect of the anesthesia wears off.</li>
                                <li><i class="fa fa-plus"></i>For the first 5-6 hours after tooth extraction it is recommended to keep an ice pack(wrapped in a soft cloth) on the outside of the jaw , in line with the surgery site. Remove the ice after 10 minutes and apply it again after another ten minutes.</li>
                    ...
                    <div class="col-lg-5 root-order">
                        <div class="root-img pb-5">
                            <img src="images/treatment/wisdom-2.png" alt="wisdom tooth" class="img-fluid">
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-5 root-order">
                        <div class="root-img pb-5">
                            <img src="images/treatment/wisdom-3.png" alt="wisdom tooth" class="img-fluid">
                        </div>
                    </div>
                    <div class="col-lg-7">
                        <div class="root-info py-5">
                           
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3"> 10 things NOT to DO after wisdom tooth extraction</h2>
                            
                            <ul class="list-style">
                                <!-- <li><i class="fa fa-plus"></i> </li> -->
                                <li><i class="fa fa-plus"></i> Do not rinse your mouth for the first 8-12 hours after extraction. </li>
                                <li><i class="fa fa-plus"></i> Do not take hot drinks or food. </li>
                                <li><i class="fa fa-plus"></i> Do not smoke for the first 2-3 days after extraction.</li>
                                <li><i class="fa fa-plus"></i> Don't chew gum for a week after pumping. </li>
                                <li><i class="fa fa-plus"></i> Do not take medications containing acetylsalicylic acid (Aspirin) which could interfere with clotting.</li>
                                <li><i class="fa fa-plus"></i> Do not brush your teeth in that area for at least a week in case of complicated extractions.</li>
                                <li><i class="fa fa-plus"></i> Do not engage in sports or heavy physical activities for the first 2 or 3 days after the extraction. </li>
                                <li><i class="fa fa-plus"></i> Sleeping with your head elevated on multiple pillows helps reduce bleeding and swelling.</li>
                                <li><i class="fa fa-plus"></i> The ideal diet after extraction consists of cold, soft foods and lots of liquids.</li>
                                <li><i class="fa fa-plus"></i> Adequate rest, in the days following the extraction, promotes rapid healing.</li>
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingOne1">
                              <a data-toggle="collapse" data-parent="#accordionEx" href="#collapseOne1" aria-expanded="true"
                                ...
                                What to expect after third molar extraction? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                            ...
                            <div id="collapseOne1" class="collapse show" role="tabpanel" aria-labelledby="headingOne1"
                              ...
                              <div class="card-body">
                              Immediately after the wisdom tooth is extracted, blood loss occurs and usually ends within a few hours. In the following days you may experience swelling and pain sensations in the vicinity of the extracted tooth. In this case, you can take painkillers or apply ice to the sore cheek. <br>To help the wound heal better, we recommend ice packs while hot foods, coffee, alcohol, cigarettes, rinsing too vigorous and taking too many medications immediately after surgery are to be avoided.
                              </div>
                            </div>
...
Can I avoid wisdom tooth extraction? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                            ...
                            <div id="collapseTwo2" class="collapse" role="tabpanel" aria-labelledby="headingTwo2"
                              data-parent="#accordionEx">
                              <div class="card-body">
                              In some cases when the gum around a wisdom tooth is very swollen in addition to extraction, there is an option to try and remove only the inflamed gum tissue. If problem arises even after that, extraction is the last resort.
                              </div>
                            </div>
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingThree3">
                              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseThree3"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                Is it painful to undergo wisdom tooth extraction? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingThree4">
                              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseThree4"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                Can you do a workout following wisdom tooth extraction? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                            ...
                            <div id="collapseThree4" class="collapse" role="tabpanel" aria-labelledby="headingThree4"
                              data-parent="#accordionEx">
                              <div class="card-body">
                              You are generally adviced to avoid any strenous activity for atleast 3-4 days after getting the wisdom tooth removed. This is because it can aggravate the blood clot increasing post operative discomfort.
                              </div>
                            </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="offset-lg-4 col-lg-4">
                            <iframe width="100%" height="315" src="https://www.youtube.com/embed/uwY6E_-WS2o" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
