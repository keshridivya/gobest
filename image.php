...
<head>
	...
	<title>
	Video Testimonials- GoBest Dentist	</title>
  ...
  <div class="textimonial-tab">
	<div class="box">
		<div class="testimonal-nav">
		  <ul>
			<li><a href="testimonials.PHP">Videos Testimonials</a>
					</li>
			<li><a href="" class="active">Imaage Testimonials</a>
					</li>
		  </ul>
		</div>
...
<!-- testimonials-text start here -->
     ...
     <?php
          ...
          ?>
	       ...
	       <div class="w3-col l3">
           <div class="video-box">	
            <iframe width="726" height="408" src="" frameborder="0" ></iframe> 
		      <div class="iframe-footer"><span class="clinic-location"><?php echo $d['client_name']; ?></span><span class="video-time"></span></div></div>
	    </div>
	  </div>
	<?php } ?>
	</div>			</div><!-- text_testimonials_wrap end here -->  
