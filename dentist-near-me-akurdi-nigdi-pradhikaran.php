...
<div class="breadcrumb pt-4 mb-0">
    ...
    <img src="assets/img/research-image/5.jpg" alt="Avatar" class="rounded" style="width:100%">
</div>
<section class="root">
            <div class="container">
            <div class="root-info ">
    <h2 style="font-family: Anton, sans-serif; font-size:50px; line-height:200%;  text-shadow: 2px 1px #fe235b;" class="mb-3 text-center" >Gobest Dentist In Akurdi.</h2>
    </div>
    <div class="row">
    <div class="col-lg-4">
