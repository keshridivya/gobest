...
<link rel="shortcut icon" href="wp-content/themes/clove/images/favicon.png" type="image/x-icon">
	<title>Dental Care & Hygiene - Gobest Dentist	</title>
...
<div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="root-info py-3">
                            <h5 style="font-family: Anton, sans-serif;" class="mb-3">DENTAL CARE AND HYGINE</h5>
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3"> ‘Because good dental care is the basic requirement for a healthy oral flora.’</h2>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-5 root-order">
                        <div class="root-img pb-5">
                            <img src="images/treatment/Dental-care-and-hygiene1.png" alt="Dental Care and Hygine" class="img-fluid">
                        </div>
                    ...
                    <div class="col-lg-7">
                        <div class="root-info py-4">
                            ...
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3"> Why is it essential to take good care of your teeth?</h2>
                            <p style="font-size:16px; line-height: 200%;">Dental deposits - also known as plaque - disrupt natural oral balance. Therefore, they must be removed regularly and thoroughly. Otherwise there is a risk of tooth decay and inflammation of the gums and the gums. New studies even confirm the link between the condition of the teeth and an increased risk of heart attack, stroke and diabetes. </p>
                                <p style="font-size:16px; line-height: 200%;" class="moretext">It has been proven that the state of the oral cavity is half dependent on how correctly and regularly the care of the oral cavity is carried out:<br>
                                <i class="fa fa-plus"></i> Leftover food contributes to the appearance of soft plaque - a harbinger of caries.<br>
                                <i class="fa fa-plus"></i> Tartar formed on the surface is one of the causes of gingivitis.<br>
                                <i class="fa fa-plus"></i> Pathogenic organisms provoke stomatitis - painful small ulcers.<br>
                                <i class="fa fa-plus"></i> Bacteria release acids that damage the enamel.<br><br>
                                ...
                                <p style="font-size:16px; line-height: 200%;">Want to know more about dental hygiene?</p>
                                
                            <a href="javascript:void()" class="btn mt-3 toggle1 display">BOOK AN APOINTMENT</a>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="root-info py-5">
                            ...
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3"> How can you do oral care at home?</h2>
                            <p style="font-size:16px; line-height: 200%;">Our experts recommend brushing your teeth in the morning and evening. Our recommendations:</p>
                            <ul class="list-style">
                                <li><i class="fa fa-plus"></i> The brush should be located at an angle of 45 ° relative to the surface of the teeth - the lateral parts are cleaned with sweeping movements from the gum to the edge + circular, chewing - back and forth;</li>
                                <li><i class="fa fa-plus"></i> To remove plaque from the tongue, you must use a special scraper - it is found in some toothbrushes;</li>
                                <li><i class="fa fa-plus"></i> The recommended duration of rinsing your teeth is 2 minutes.</li>

                            </ul>
                            <p style="font-size:16px; line-height: 200%;">Still confused about proper techniques of oral care? Our experts will be happy to help.</p>
                    ...
                    <div class="col-lg-5">
                        <div class="pt-5">
                            <img src="images/treatment/Dental-care-and-hygiene2.png" alt="Dental Care and Hygine" class="img-fluid">
                ...
                <div class="dental root">
                  <div class="container">
                    ...
                    <h2 style="font-family: Anton, sans-serif;" class="mb-3"> What teeth like to "eat"</h2>
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="root-info">
                            <h3 style="width:100%; font-family: Anton,sans-serif;"> Balanced diet in proteins, fats and carbohydrates, vitamins and minerals</h3>
                            <h3 style="width:100%; font-family: Anton,sans-serif;"> “chew-intensive” foods such as apples, carrots and nuts</h3>
                            <h3 style="width:100%; font-family: Anton,sans-serif;"> Increased intake of fibrous foods</h3>
                            <h3 style="width:100%; font-family: Anton,sans-serif;"> More consumption of calcium and vitamin D rich foods</h3>
                            <h3 style="width:100%; font-family: Anton,sans-serif;"> Avoid frequent snacks</h3>
                            <h3 style="width:100%; font-family: Anton,sans-serif;"> Avoid excessive consumption of sweets and muffins. </h3>
                      ...
                      <!-- <div class="col-lg-5">
                        <div class="pt-2">
                            <img src="image/treatment/crown2.png" alt="Dental Care and Hygine" class="img-fluid">
                        </div>
                      </div> -->
                    </div>
                  </div>
            ...
            <section class="root">
              <div class="container">
                <div class="row">
                    <div class="col-lg-5 root-order">
                        <div class="root-img">
                            <img src="images/treatment/Dental-care-and-hygiene3.png" alt="Dental Care and Hygine" class="img-fluid">
                        </div>
                    </div>
                    <div class="col-lg-7">
                        <div class="root-info py-5">
                            ...
                            <ul class="list-style">
                                ...
                                <li><i class="fa fa-plus"></i> Polishing the tooth surfaces</li>
                                <li><i class="fa fa-plus"></i> Fluoridation</li>
                                <li><i class="fa fa-plus"></i> Advice on daily oral hygiene</li>
                            </ul>
                           <p style="font-size:16px; line-height: 200%;" class="moretext1">The result is a radiant smile - and clean, healthy teeth that are not only well cared for, but also look like that.. Our tip for a healthy mouth: Make sure you have regular check-ups and professional teeth cleaning. Ideally twice a year, more often if you have problems with inflammation and oral hygiene. Your teeth will thank you for it - with long health into old age.</p>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="root-info py-4">
                    <h5 style="font-family: Anton, sans-serif;" class="mb-3">HOW</h5>
                    <h2 style="font-family: Anton, sans-serif;" class="mb-3"> How is the process of Professional cleaning done?</h2>
                    <h4 style="font-family: Anton, sans-serif;">Stages of professional teeth cleaning:</h4>
                    <p style="font-size:16px; line-height: 200%;">1. Examination: <span class="moretext2">during this the periodontist dentist determines the parotondologic status, namely: <br>
                    <i class="fa fa-plus"></i> the presence of supragingival, subgingival dental deposits,<br>
                    <i class="fa fa-plus"></i> Condition of periodontal tissues.
                    </span> </p>
                    <a class="moreless-button2" href="javascript:void()">Read more</a><br><br>
                    <p style="font-size:16px; line-height: 200%;">Before treatment </p>
                        ...
                        <div class="accordion md-accordion" id="accordionEx" role="tablist" aria-multiselectable="true">
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingOne1">
                              <a data-toggle="collapse" data-parent="#accordionEx" href="#collapseOne1" aria-expanded="true"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                   What type of toothbrush should be used? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                            ...
                            <div id="collapseOne1" class="collapse show" role="tabpanel" aria-labelledby="headingOne1"
                              ...
                              <div class="card-body">
                                Soft bristles should be chosen to ensure that gums are not damaged while brushing the teeth. Hard bristles can damage the gums and teeth in long run. Also care should be taken not to apply excessive pressure while brushing the teeth.
                              </div>
                            </div>
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingTwo2">
                              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseTwo2"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                  Do I need to use a mouthwash daily? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingThree3">
                              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseThree3"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                   What are signs of dental trouble that needs a visit to dentist? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingThree3">
                              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseThree3"
                                aria-expanded="false" aria-controls="collapseThree3">
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                  Why do you need regular dental visits? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                            ...
                            <div id="collapseThree3" class="collapse" role="tabpanel" aria-labelledby="headingThree3"
                              data-parent="#accordionEx">
                              <div class="card-body">
                                There are areas in your teeth which might not be accessible to regular brushing. These areas can be cleaned by regular dental visits and also hidden dental problems can be detected.
                              </div>
                            </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="offset-lg-4 col-lg-4">
                           <iframe width="100%" height="315" src="https://www.youtube.com/embed/tknG7zGWkBU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                        <!-- <div class="col-lg-4">
