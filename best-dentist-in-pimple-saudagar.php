...
<link rel="shortcut icon" href="wp-content/themes/clove/images/favicon.png" type="image/x-icon">
  <title>
  Pimple Saudagar Branch - Gobest Dentist </title>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.min.js" ></script>
  ...
  <script type="text/javascript">
    window._wpemojiSettings = {
      ...
      "svgExt": ".svg",
      "source": {
        "concatemoji": "https:\/\/clovedental.in\/wp-includes\/js\/wp-emoji-release.min.js?ver=5.7.2"
      }
    };
    ! function (e, a, t) {
  ...
  <link rel='stylesheet' id='wp-block-library-css'
    href='wp-includes/css/dist/block-library/style.min9f31.css?ver=5.7.2' type='text/css' media='all' />
  <link rel='stylesheet' id='contact-form-7-css'
    href='wp-content/plugins/contact-form-7/includes/css/styles5697.css?ver=5.5.3' type='text/css' media='all' />
  <link rel='stylesheet' id='email-subscribers-css'
    href='wp-content/plugins/email-subscribers/lite/public/css/email-subscribers-public5560.css?ver=5.0.4'
    type='text/css' media='all' />
  <link rel='stylesheet' id='twentythirteen-style-css'
    href='wp-content/themes/clove-child/style4a02.css?ver=2013-07-18' type='text/css' media='all' />
  <script type='text/javascript' src='wp-includes/js/jquery/jquery.min9d52.js?ver=3.5.1' id='jquery-core-js'>
  </script>
  ...
  <script type='text/javascript' id='email-subscribers-js-extra'>
    ...
    var es_data = {
      ...
      "es_ajax_url": "https:\/\/clovedental.in\/wp-admin\/admin-ajax.php"
    };
    /* ]]> */
  </script>
  <script type='text/javascript'
  ...
  <link rel="alternate" type="application/json+oembed"
    href="wp-json/oembed/1.0/embedacef.json?url=https%3A%2F%2Fclovedental.in%2Fcontact-us%2F" />
  ...
  <script id="sourcecode">
    ...
    jQuery(document).ready(function () {
      ...
      jQuery(".acc-tab,.news-popup .imgbox .close").click(function () {
        /* Toggle */
        jQuery(".newscontent").removeClass("active");
      });

      jQuery(".acc-imgbox").click(function () {
        /* Toggle */
      ...
      jQuery('.ytLink').on('click', function (e) {
        jQuery('#ytVids2')[0].src = jQuery(this).attr('href') +
          '?autoplay=1&?modestbranding=0&rel=0&showinfo=0&modestbranding=1&modestbranding=1';
        e.preventDefault();
        jQuery(this).hide();
      });
      ...
      jQuery('.ytLink2').on('click', function (e) {
        jQuery('#ytVids3')[0].src = jQuery(this).attr('href') +
          '?autoplay=1&?modestbranding=0&rel=0&showinfo=0&modestbranding=1&modestbranding=1';
        e.preventDefault();
        jQuery(this).hide();
      });
      ...
      jQuery(function () {
        jQuery(".table-doctors table tr").slice(0, 6).addClass('display');
        jQuery("#loadMore").on('click', function (e) {
          e.preventDefault();
          jQuery(".table-doctors table tr:hidden").slice(0, 6).addClass('display');
        });
      });
    ...
    $(document).ready(function () {
      ...
      $("#rsform").submit(function (event) {
        ...
        if (name == "") {
          $("#r_app_error2").show();
          $("#r_app_error2").html("Please enter full name.");
          error = 1;
        } else if (isNaN(name) == false) {
          $("#r_app_error2").show();
          $("#r_app_error2").html("Please enter only alphabet value.");
          error = 1;
        } else if (!/^[a-zA-Z\s ._-]+$/.test(name)) {
          $("#r_app_error2").show();
          $("#r_app_error2").html("Only dot (.) as a special character & alphabets are accepted.");
          error = 1;
        } else {
          $("#r_app_error2").hide();
        }
        ...
        if (phone1 == "") {
          $("#r_app_error1").show();
          $("#r_app_error1").html("Please enter mobile number.");
          error = error + 2;
        } else if (isNaN(phone) == true) {
          $("#r_app_error1").show();
          $("#r_app_error1").html("Please enter only numeric value.");
          error = error + 2;
        } else if (num < 10) {
          $("#r_app_error1").show();
          $("#r_app_error1").html("Please fill the numeric values greater than 9.");
          error = error + 2;
        } else {
          ...
          $.ajax({
            ...
            success: function (html) {
              ...
              if (html == "Yes") {
                $("#r_app_error1").show();
                $("#r_app_error1").html(
                  "*The phone number mentioned has been blocked due to multiple unscrupulous requests generated. Kindly use a different phone number to register your request."
                  );
                error = error + 2;
              } else {
                $("#r_app_error1").hide();
...
<body class="home-page">
  ...
  <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5JX6KNP" height="0" width="0"
      style="display:none;visibility:hidden"></iframe></noscript>
  <!-- End Google Tag Manager (noscript) -->

  <noscript><img height="1" width="1" style="display:none"
      src="https://www.facebook.com/tr?id=400629990135976&amp;ev=PageView&amp;noscript=1"
      alt="Clove Dental" /></noscript>
...
@keyframes hideBlack {
  ...
  to { clip-path: polygon(100% 0, 100% 0, 100% 100%, 100% 100%); }
    ...
    <style>
.mask1 {
  -webkit-mask: radial-gradient(rgba(0, 0, 0, 1), transparent 300%); 
  /* mask-image: color  */
...
<div class="breadcrumb pt-4 mb-0">
      <div class="box ">
        <ul>
          ...
          <li>Pimple Saudagar Branch</li>
        </ul>
      </div>
    </div>
    <div class="mask1 mt-0">
    <img src="assets/img/research-image/7.jpg" alt="Avatar" class="rounded" style="width:100%">
</div>
<section class="root">
            <div class="container">
            <div class="root-info ">
    <h2 style="font-family: Anton, sans-serif; font-size:50px; line-height:200%;  text-shadow: 2px 1px #fe235b;" class="mb-3 text-center" >Gobest Dentist In Pimple Saudagar.</h2>
    </div>
    <div class="row">
    <div class="col-lg-4">
                        <div class="root-info py-5">
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3">Address:</h2>
                            <h5 style="font-family: 'Lora', sans-serif;font-family: 'Muli', sans-serif; font-size:20px; line-height: 200%;" class="mb-3">2nd Floor, Vision 9 Mall, Shop no, 269, Kunal Icon Rd, Pimple Saudagar, Pune, Maharashtra 411027</h5>
                        </div>
                    </div>

                    <div class="col-lg-8">
                    <div class="root-img pb-5">
                            <iframe id="pimple" style="border:black;" class="tabcontent border rounded border-secondary"  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3781.5573524673227!2d73.79077811489384!3d18.59398458736632!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xc5b1e259af1e4cdb!2sGo%20Best%20Dentist%20-%20earlier%20Mokashi%20Dental%20clinic%2C%20Pimple%20Saudagar!5e0!3m2!1sen!2sin!4v1629264870279!5m2!1sen!2sin" width="100%" height="350" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
...
<section class="root mt-0 pt-0">
    ...
    <div class="row">
      ...
      <div class="col-sm-12">
      <input type="submit" name="subm" class="btn btn-primary" value="Submit" onclick="return confirm('Thanks for Contacting Gobest Dentist. Pimple Saudagar Branch');"><br>
      </div>
    </div>
  </form>
                        </div>
   ...
   <!-- <script type="text/javascript">
    ...
    <script type='text/javascript' id='wp-polyfill-js-after'>
      ('fetch' in window) || document.write(
        '<script src="wp-includes/js/dist/vendor/wp-polyfill-fetch.min6e0e.js?ver=3.0.0"></scr' + 'ipt>');
      (document.contains) || document.write(
        '<script src="wp-includes/js/dist/vendor/wp-polyfill-node-contains.min2e00.js?ver=3.42.0"></scr' + 'ipt>');
      (window.DOMRect) || document.write(
        '<script src="wp-includes/js/dist/vendor/wp-polyfill-dom-rect.min2e00.js?ver=3.42.0"></scr' + 'ipt>');
      (window.URL && window.URL.prototype && window.URLSearchParams) || document.write(
        '<script src="wp-includes/js/dist/vendor/wp-polyfill-url.min5aed.js?ver=3.6.4"></scr' + 'ipt>');
      (window.FormData && window.FormData.prototype.keys) || document.write(
        '<script src="wp-includes/js/dist/vendor/wp-polyfill-formdata.mine9bd.js?ver=3.0.12"></scr' + 'ipt>');
      (Element.prototype.matches && Element.prototype.closest) || document.write(
        '<script src="wp-includes/js/dist/vendor/wp-polyfill-element-closest.min4c56.js?ver=2.0.2"></scr' + 'ipt>');
      ('objectFit' in document.documentElement.style) || document.write(
        '<script src="wp-includes/js/dist/vendor/wp-polyfill-object-fit.min531b.js?ver=2.3.4"></scr' + 'ipt>');
    </script>
    <script type='text/javascript' id='contact-form-7-js-extra'>
      /* <![CDATA[ */
      var wpcf7 = {
        "api": {
          "root": "https:\/\/clovedental.in\/wp-json\/",
    ...
    <script type='text/javascript' src='wp-content/plugins/contact-form-7/includes/js/index5697.js?ver=5.5.3'
      id='contact-form-7-js'></script>
    <script type='text/javascript' src='wp-includes/js/imagesloaded.mineda1.js?ver=4.1.4' id='imagesloaded-js'>
    </script>
    <script type='text/javascript' src='wp-includes/js/masonry.min3a05.js?ver=4.2.2' id='masonry-js'></script>
    <script type='text/javascript' src='wp-includes/js/jquery/jquery.masonry.minef70.js?ver=3.1.2b'
    ...
    <script>
      jQuery(document).ready(function () {
        ...
        jQuery(".video-btn-box").click(function () {
          jQuery(".corporate-video-wrap").addClass('active');
        });

        jQuery(".corporate-video-wrap .close").click(function () {
          jQuery(".corporate-video-wrap").removeClass('active');
        });
