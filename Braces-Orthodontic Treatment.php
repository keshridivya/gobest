...
<link rel="shortcut icon" href="wp-content/themes/clove/images/favicon.png" type="image/x-icon">
	<title>Braces-Orthodontic-Treatment - Gobest Dentist	</title>
  	...
  	<div class="breadcrumb">
		<div class="box">
			<ul>
				...
				<li>Braces - Orthodontic Treatment</li>
			</ul>
		</div> 
	</div>
...
<div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="root-info py-3">
                            ...
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3"> ‘If you don't like how your teeth look or work, orthodontic treatment may be the solution.’</h2>
                ...
                <div class="root-img pb-5">
                            <img src="images/treatment/ortho-1.png" alt="orthodontic" class="img-fluid">
                        </div>
                </div>
                    <div class="col-lg-7">
                        <div class="root-info py-4">
                            <h5 style="font-family: Anton, sans-serif;" class="mb-3">WHY</h5>
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3">  	Why should i get my misaligned teeth corrected?</h2>
                            <p style="font-size:16px; line-height: 200%;">Apart from an aesthetic point of view, Orthodontic treatment has helped many people to avoid serious health problems. Scientists conducted a series of experiments, according to the results of which it became clear that disorders of the dentition can be the cause of very serious diseases. </p>
                            <p style="font-size:16px; line-height: 200%;" class="moretext">If the food is not chewed thoroughly enough, then sooner or later problems arise with the digestive system, most often the gastrointestinal tract suffers from this, subsequently a stomach ulcer appears, and sometimes the liver begins to get sick. More than 40% of people with jaw or dental problems have speech impairments.<br>Crooked teeth can lead to periodontitis - a serious illness accompanied by bad breath, as the teeth become mobile, food debris accumulates in the gaps between the teeth and gums. It can be treated temporarily by <a href="/dental-treatments/teeth-scaling-polishing-in-pune.php">scaling and root planning </a>  but re-occurs due to improper maintenance.<br>Periodontitis promotes the spread of microbes, which, one way or another, enter the stomach, which can cause very serious diseases.<br>In the end, the teeth affected by periodontitis simply begin to fall out.</p>
                            <a class="moreless-button" href="javascript:void().">Read more</a>
                            <br><br>

                           <p style="font-size:16px; line-height: 200%;"><strong>Looking for <a href="\change\Braces-Orthodontic Treatment.php">Braces/orthodontic treatment in Pune?</a></strong></p>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="root-info py-5">
                            <h5 style="font-family: Anton, sans-serif;" class="mb-3">WHO</h5>
                    ...
                    <div class="col-lg-5 root-order">
                        <div class="root-img pb-5">
                            <img src="images/treatment/ortho-2.png" alt="orthodontic" class="img-fluid">
                        </div>
                    </div>
                ...
                <div class="dental root">
                  <div class="container">
                    ...
                    <h2 style="font-family: Anton, sans-serif;" class="mb-3">	Psychological and physical benefits of orthodontic treatment</h2>
                    <p style="line-height: 200%;"> In addition to psychological benefits such as increased self-confidence, orthodontic treatment also brings many physical benefits, including a beautiful smile thanks to the correction: </p>
                    ...
                    <div class="row">
                      <div class="col-lg-8">
                        <div class="root-info">
                            ...
                            <h3 style="width:100%; font-family: Anton, sans-serif;"> Bad bites that can damage teeth and gums.</h3>
                            <h3 style="width:100%; font-family: Anton, sans-serif;"> Straighten protruding or misaligned teeth.</h3>
                            <h3 style="width:100%; font-family: Anton, sans-serif;"> Elimination of gaps between teeth.</h3>
                            <h3 style="width:100%; font-family: Anton, sans-serif;"> Correction of crooked and crowded teeth.</h3>
                            <h3 style="width:100%; font-family: Anton, sans-serif;"> Correcting problems with speaking, breathing, or chewing.</h3>
                            <h3 style="width:100%; font-family: Anton, sans-serif;"> Misaligned jaws (which may affect your facial profile).</h3><br>
                            <p style="line-height: 200%;">An orthodontist can also help diagnose and treat obstructive sleep apnea and can help treat persistent thumb-sucking habits in children.</p>
            ...
            <section class="root">
              <div class="container">
                <div class="row">
                    <div class="col-lg-5 root-order">
                        <div class="root-img pb-5">
                            <img src="images/treatment/ortho-3.png" alt="orthodontic" class="img-fluid">
                        </div>
                    </div>
                    <div class="col-lg-7">
                        <div class="root-info py-5">
                            <h5 style="font-family: Anton, sans-serif;" class="mb-3">WHY</h5>
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3">  	Why choose us ?</h2>
                            <p style="font-size:16px; line-height: 200%;">We have options for every taste.</p>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="root-info py-5">
                            ...
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3"> How Long Does A Treatment Take?</h2>
                            <p style="font-size:16px; line-height: 200%;">Adjustments to the position of the teeth and jaws, including the stabilization phase that is usually required, generally extend over one year to 18 months to 2 years. Orthodontic patients, and possibly their parents as well, must therefore patiently be prepared for long-term care from the orthodontist.</p>
                            <p style="font-size:16px; line-height: 200%;" class="moretext1">This is due to the fact that in many cases growth is used for treatment and relatively weak biological forces are used for tooth correction so as not to damage the teeth and the tooth supporting structure. After the treatment has ended, it is usually necessary to stabilize the result achieved so that there is no relapse.</p>
                    ...
                    <div class="col-lg-12">
                        <div class="root-info py-5">
                            ...
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3"> Your Cooperation Is The Key!</h2>
                            <p style="font-size:16px; line-height: 200%;">So that the therapy is successful and harmful side effects are avoided, such as the decalcification of the tooth enamel, damage to the tooth roots and the tooth support apparatus, your cooperation is very important. You can contribute to a quicker treatment success yourself by wearing the equipment intensively and regularly, following the instructions for optimal oral hygiene and keeping the check-ups.</p>
                          <p style="font-size:16px; line-height: 200%;">If you experience pain, if the appliance is lost or damaged, or if the brace does not fit properly, you should visit us immediately. Under no circumstances should you stop wearing the braces for a long time - for whatever reason (pain, illness, vacation, school camp, etc.).</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-5 root-order">
                        <div class="root-img pb-5">
                            <img src="images/treatment/ortho-4.png" alt="orthodontic" class="img-fluid">
                        </div>
                    </div>
                    <div class="col-lg-7">
                        <div class="root-info py-5">
                           
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3">  Proper Nutrition Is Important!</h2>
                           <p style="font-size:16px; line-height: 200%;">In addition to good oral hygiene, proper nutrition is of great importance. Sticky foods and sweets should be avoided as much as possible because of the increased risk of tooth decay. Chewing gum or sticky candies should be avoided entirely. Hard foods - like apples, carrots - are healthier, but they can cause brackets and ligaments to loosen and wires to bend. Therefore, you should chew carefully.</p>
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingOne1">
                              <a data-toggle="collapse" data-parent="#accordionEx" href="#collapseOne1" aria-expanded="true"
                                ...
                                Is there an age limit for orthodontic treatment? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                            ...
                            <div id="collapseOne1" class="collapse show" role="tabpanel" aria-labelledby="headingOne1"
                              ...
                              <div class="card-body">
                              Orthodontics is not a question of age. There are numerous treatment options from early treatment in childhood to regular treatment in adulthood to treatment in adults. Misaligned teeth can be corrected even in old age. The only prerequisites are adequate oral hygiene, healthy teeth holding apparatus and good cooperation and motivation.
                              </div>
                            </div>
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingTwo2">
                              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseTwo2"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                Removal of permanent teeth - does it have to be?<i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingThree3">
                              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseThree3"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                Can caries develop under the brackets? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                            ...
                            <div id="collapseThree3" class="collapse" role="tabpanel" aria-labelledby="headingThree3"
                              data-parent="#accordionEx">
                              <div class="card-body">
                              This is almost impossible because the brackets are firmly glued to the tooth surface. The enamel is completely covered below the bracket and can therefore not be colonized by plaque. During the appointments at the polyclinic, we check whether the brackets are still secure and, if necessary, glue them to the teeth.
                              </div>
                            </div>
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingThree4">
                              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseThree4"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                Can the teeth move again after a completed treatment? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                            ...
                            <div id="collapseThree4" class="collapse" role="tabpanel" aria-labelledby="headingThree4"
                              data-parent="#accordionEx">
                              <div class="card-body">
                              Unfortunately, yes: Factors such as residual growth, harmful habits such as chewing pencils or existing malfunctions can cause teeth to shift again. The more pronounced the misaligned teeth were at the beginning of the treatment, the more the teeth tend to return to their original position. However, retention devices or a fixed retainers can prevent this.
                              </div>
                            </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="offset-lg-4 col-lg-4">
                            <iframe width="100%" height="315" src="https://www.youtube.com/embed/CDSnUmRCavU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
