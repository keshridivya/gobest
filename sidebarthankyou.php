...
<input type="text" name="name_r" id="name_id_r" class="form-control" placeholder="Enter Your Name *" value="">
<p class="error-n error-c" id="r_app_error2"></p>
</div>
<div class="fill_box">
<input type="tel" name="phone_r" id="phone_r" class="form-control" maxlength="10" minlength="10" pattern="^\d{10}$" required value="" placeholder="Enter Your Mobile Number *">
...
<div class="instant-captcha">
								...
								<img id="captcha_code1_r" src="captcha/captchaCode0b30.jpg?id=2" alt="Captcha"/>
...
<div class="clearfix"></div>
        <div class="form-disclaimer"><input id="disclaimer_r" checked="checked" name="disclaimer_r" type="checkbox" value="Y"><label style="font-size:9px;color: #000;" for="disclaimer_r">I declare that the information provided above is correct. I would like to receive communication about Clove Dental services.</label></div>                 
 <div class="clearfix"></div>
...
<input type="text" readonly class="req_submitbtn plwt" value="Please wait...">
  ...
  <div class="form-disclaimer"><label style="font-size: 9px; color:#000;">By clicking Submit you agree to be contacted by Clove Dental over Phone or SMS/WhatsApp/Email.<br></label></div>
</div>
</form>
</div>
</div>
...
<div class="side-menu">
	...
	<div class="logo-side-menu">
		<a href="index.html"><img src="wp-content/themes/clove/images/img_logo_new.png" alt="Clove Dental Clinic"></a>
	</div>
	<div class="side-menu-scroll">
		...
		<div class="common phone">
			<h3>Phone Number</h3>
			<ul>
				<li>NORTH INDIA - <a href="tel:9667353232" onClick="ga('send','event','footer','click','website', 1);"><i class="fa fa-phone" aria-hidden="true"></i> 96 6735 3232</a></li>
				<li>SOUTH INDIA - <a href="tel:9393553232" onClick="ga('send','event','footer','click','website', 1);"><i class="fa fa-phone" aria-hidden="true"></i> 93 9355 3232</a></li>
			</ul>
			<div class="toll" style="
    clear: both;
   
    margin: 0 auto;
    text-align: center;
    padding: 13px 0 3px 0;
"><span><img src="wp-content/uploads/2021/03/Untitled-1.png"> </span><a href="tel:18003093232" onClick="ga('send','event','footer','click','website', 1);"style="
    color: #fff;
    font-size: 17px;
...
">1800-309-3232</a></div>
		...
		<div class="common links">
			<ul>
			<li><a href="about-us/index.html"><span><img src="wp-content/themes/clove-child/images/hospital-icon.png" alt="best dental hospital"></span>About us</a></li>
				...
				<li><a href="openings/index.html"><span><img src="wp-content/themes/clove-child/images/career-icon.png" alt="dental clinic in delhi"></span>CAREER</a></li>
				<li><a href="index.html"><span><img src="wp-content/themes/clove-child/images/info-icon.png" alt="dentist in delhi"></span>Contact us</a></li>
			</ul>
		</div>
		<div class="common follow">
			<h3>Follow Us</h3>
			<ul>
				<li><a href="https://twitter.com/Clove_Dental" title="Twitter" target="_blank"><i class="fa fa-twitter-square" aria-hidden="true"></i></a></li>
				<li><a href="https://www.facebook.com/clovedentalindia" title="Facebook" target="_blank"><i class="fa fa-facebook-square" aria-hidden="true"></i></a></li>
				<li><a href="https://www.linkedin.com/company/clove-dental/" title="LinkedIn" target="_blank"><i class="fa fa-linkedin-square" aria-hidden="true"></i></a></li>
				<li><a href="https://www.youtube.com/channel/UCNrZDA3KJmta5kO9URiSNhQ" title="Youtube" target="_blank"><i class="fa fa-youtube-play" aria-hidden="true"></i></a></li>
				<li><a href="https://www.instagram.com/clovedentalindia/" title="Instagram" target="_blank"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
			</ul>
		</div>
		</div>
	</div>
...
<div class="head-outer">
	<div class="header-main"> 
		<span class="header-bg-mbl">&nbsp;</span>
		<div class="logo-box">
			<a href="index.html" class="logo-dsk"><img src="wp-content/themes/clove/images/img_logo_new.png" alt="Clove Dental Clinic"></a>
			<a href="index.html" class="logo-mbl"><img src="wp-content/themes/clove/images/logo_clove_new.png" alt="Clove Dental Clinic"></a>
		</div>
		...
		<div class="nav-bar">
			<div class="navigation">
				<div class="navigation-scroll">
					<div class="menu-menu-1-container"><ul id="primary-menu" class="menu"><li id="menu-item-427" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-427"><a href="specialties/index.html">Treatments</a>
<ul class="sub-menu">
	<li id="menu-item-8191" class="menu-item menu-item-type-post_type menu-item-object-specialties menu-item-8191"><a href="specialties/dental-fillings/index.html">Dental Fillings</a></li>
	<li id="menu-item-8192" class="menu-item menu-item-type-post_type menu-item-object-specialties menu-item-8192"><a href="specialties/root-canal-treatment/index.html">Root Canal Treatment</a></li>
	<li id="menu-item-8193" class="menu-item menu-item-type-post_type menu-item-object-specialties menu-item-8193"><a href="specialties/wisdom-teeth-removal-extraction/index.html">Wisdom Teeth Removal</a></li>
	<li id="menu-item-7259" class="menu-item menu-item-type-post_type menu-item-object-specialties menu-item-7259"><a href="specialties/braces-aligners/index.html">Braces &#038; Aligners</a></li>
	<li id="menu-item-10646" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-10646"><a href="specialties/aligners/index.html">Clear Aligners</a></li>
	<li id="menu-item-8194" class="menu-item menu-item-type-post_type menu-item-object-specialties menu-item-8194"><a href="specialties/dental-implant/index.html">Dental Implants</a></li>
	<li id="menu-item-8195" class="menu-item menu-item-type-post_type menu-item-object-specialties menu-item-8195"><a href="specialties/fixed-partial-denture/index.html">Dentures</a></li>
	<li id="menu-item-7261" class="menu-item menu-item-type-post_type menu-item-object-specialties menu-item-7261"><a href="specialties/dental-bridges-crowns/index.html">Bridges &#038; Crowns</a></li>
	<li id="menu-item-8196" class="menu-item menu-item-type-post_type menu-item-object-specialties menu-item-8196"><a href="specialties/teeth-whitening/index.html">Teeth Whitening</a></li>
	<li id="menu-item-7258" class="menu-item menu-item-type-post_type menu-item-object-specialties menu-item-7258"><a href="specialties/smile-makeover/index.html">Smile Makeover</a></li>
	<li id="menu-item-7256" class="menu-item menu-item-type-post_type menu-item-object-specialties menu-item-7256"><a href="specialties/kids-dentistry/index.html">Kids Dentistry</a></li>
	<li id="menu-item-8197" class="menu-item menu-item-type-post_type menu-item-object-specialties menu-item-8197"><a href="specialties/mouth-ulcer-treatment/index.html">Mouth Ulcers</a></li>
	<li id="menu-item-8003" class="menu-item menu-item-type-post_type menu-item-object-specialties menu-item-8003"><a href="specialties/preventive-dentistry/index.html">Preventive Dentistry</a></li>
	<li id="menu-item-7257" class="menu-item menu-item-type-post_type menu-item-object-specialties menu-item-7257"><a href="specialties/gum-diseases-treatment/index.html">Advanced Gum Treatment</a></li>
</ul>
</li>
<li id="menu-item-4792" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-4792"><a href="#">Membership Plans</a>
<ul class="sub-menu">
	<li id="menu-item-4817" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-4817"><a href="platinum-dental-membership-plan/index.html">Platinum</a></li>
	<li id="menu-item-13797" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-13797"><a href="dental-health-plan-dhp/index.html">Dental Health Plan</a></li>
</ul>
</li>
<li id="menu-item-7267" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-7267"><a href="#">Patient Safety</a>
<ul class="sub-menu">
	<li id="menu-item-12108" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-12108"><a href="10x-safety-at-clove/index.html">10x Safety@Clove</a></li>
	<li id="menu-item-7269" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-7269"><a href="sterilization/index.html">4 Step Sterilization</a></li>
	<li id="menu-item-12104" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-12104"><a href="safety-equipment/index.html">Safety Equipment</a></li>
	<li id="menu-item-7271" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-7271"><a href="dental-equipment-technology/index.html">Equipment &#038; Technology</a></li>
	<li id="menu-item-7268" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-7268"><a href="quality/index.html">Quality</a></li>
</ul>
</li>
<li id="menu-item-11888" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-11888"><a href="clove-dental-doctors/index.html">Our Doctors</a></li>
<li id="menu-item-14145" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-14145"><a href="openings/index.html">Careers</a></li>
<li id="menu-item-8073" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-8073"><a href="dentist-near-me/index.html">Find a Clinic</a></li>
</ul></div>					<div class="mobile-nav">
						<ul>
							<li><a href="about-us/index.html">About us</a></li>
							<!--<li><a href="https://clovedental.in/clove-dental-doctors/">Our Doctors</a></li>-->
							<li><a href="openings/index.html">CAREER</a></li>
							<li><a href="index.html">Contact us</a></li>
						</ul>
					</div>
				</div>
			</div>
			<a href="javascript:void(0);" class="call-back click-form" style="color:#f5781d;">Instant Callback</a>
		</div>
				<a href="appointments.html" title="Book an appointment" class="book-btn">
		<i class="fa fa-calendar" aria-hidden="true"></i> <samp>book an <span>appointment</span></samp></a>
				<div class="number-mbl">
		 <a href="javascript:void(0);" class="click-form"><strong><img src="wp-content/themes/clove-child/images/ico_callback.png" alt="dentist nearby" width="20" height="20"></strong><span>Callback</span></a>
			<ul>
			<li><span>North </span><a href="tel:9667353232" onClick="ga('send','event','footer','click','website', 1);"> 9667353232</a></li>
		   <li><span>South </span><a href="tel:9393553232" onClick="ga('send','event','footer','click','website', 1);"> 9393553232</a></li>
			</ul>
		</div>
	</div>
	<div class="head-gray">
		<ul>
			<li><a href="dentist-near-me.html"><strong><i class="fa fa-plus-circle" aria-hidden="true"></i></strong><span>Find a Clinic</span></a></li>
						<li><a href="appointments.html" title="Book an appointment" class="book-btn"><strong><i class="fa fa-calendar" aria-hidden="true"></i></strong><span>Book An Appointment</span></a></li>
						<!--<li><a href="javascript:void(0);" class="click-form"><strong><img src="https://clovedental.in/wp-content/themes/clove-child/images/ico_callback.png" alt="dentist nearby"></strong><span>Get callback</span></a></li>-->
			 <li><a href="javascript:void(0);" class="patient_safety"><strong><img src="wp-content/uploads/2020/05/safety_shield.png" alt="safety_shield" width="20" height="20"></strong><span>Patient safety</span><!--<i class="fa fa-caret-down"></i>--></a>
                   <ul class="dropdown_patient_safety">
				   <li><a href="10x-safety-at-clove/index.html">10x Safety@Clove</a></li>
				    <li><a href="sterilization/index.html">4 Step Sterilization</a></li>
					 <li><a href="safety-equipment/index.html">Safety Equipment</a></li>
                     <li><a href="dental-equipment-technology/index.html">Equipment & Technology</a></li>
...
$fields = array('name' => 'name', 'PhoneNumber' => 'PhoneNumber', 'comments' => 'comments', 'email' => 'email', 'resume' => 'resume'); // array variable name => Text to appear in email
...
<div class="full-footer">
		<div class="footer-top">
			...
			<img src="wp-content/themes/clove-child/images/bg_footer_teeth_top.png" alt="dentist near my location">
			</div>
		<div class="box">
			<div class="full-footer-in">
				<div class="links-box">
					<div class="links-comman-box toggle-mbl">
						<h4>Branches</h4>
						<div class="menu-clove-advantage-container"><ul id="menu-clove-advantage" class="menu">
...
<li id="menu-item-12292" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-12292"><a href="testimonials-text/index.html"> Akurdi Branch</a></li>
<li id="menu-item-3006" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-3006"><a href="outreach-programs/index.html">Wakad Branch</a></li>
<li id="menu-item-7280" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-7280"><a href="patient-feedback/index.html"> Baner Branch</a></li>
<li id="menu-item-7275" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-7275"><a href="pay-online/index.html"> Pimple Saudagar</a></li>
</ul></div>					</div>
					<div class="links-comman-box toggle-mbl">
						<h4>ABOUT US </h4>
						<div class="menu-about-container"><ul id="menu-about" class="menu"><li id="menu-item-13922" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-13922"><a href="about-us/index.html">About Us</a></li>
<li id="menu-item-632" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-632"><a href="vision-mission/index.html">Home</a></li>
<li id="menu-item-633" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-633"><a href="clove-dental-promise/index.html">About US</a></li>
<li id="menu-item-7276" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-7276"><a href="outreach-programs/index.html">Treatments</a></li>
<li id="menu-item-634" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-634"><a href="board-of-directors/index.html"> Reviews</a></li>
<li id="menu-item-3017" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-3017"><a href="awards-and-recognition/index.html">  Careers</a></li>
<li id="menu-item-3018" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-3018"><a href="gallery/index.html">Gallery</a></li>
<li id="menu-item-635" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-635"><a href="contact-us/index.html">Contact Us</a></li>
</ul></div>					</div>
					<div class="links-comman-box toggle-mbl">
						<h4>USEFUL LINKS </h4>
						<div class="menu-usefull-links-container"><ul id="menu-usefull-links" class="menu"><li id="menu-item-8156" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-8156"><a href="blog/index.html">Blogs</a></li>
...
<li id="menu-item-6779" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-6779"><a href="privacy-policy/index.html">Privacy Policy</a></li>
...
<li id="menu-item-7288" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-7288"><a href="appointments/index.html">Book An Appointment</a></li>
...
<li id="menu-item-13135" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-13135"><a href="refund-policy/index.html">Refund &#038; Re-treatment Policy</a></li>
</ul></div>					</div>
					<div class="links-comman-box toggle-mbl">
						<h4>Treatments</h4>
						<div class="menu-join-clove-container"><ul id="menu-join-clove" class="menu"><li id="menu-item-7235" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-7235"><a href="openings/index.html"> Tooth Extraction</a></li>
<li id="menu-item-7236" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-7236"><a href="recruitment-process/index.html">Dental Care & Hygiene </a></li>
<li id="menu-item-7236" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-7236"><a href="recruitment-process/index.html">Teeth Whitening  </a></li>
<li id="menu-item-7236" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-7236"><a href="recruitment-process/index.html">Dental X-Ray </a></li>
<li id="menu-item-7236" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-7236"><a href="recruitment-process/index.html">Root Canal Treatment  </a></li>
<li id="menu-item-7236" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-7236"><a href="recruitment-process/index.html">Crowns And Bridges </a></li>
<li id="menu-item-7236" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-7236"><a href="recruitment-process/index.html">Wisdom Tooth Extraction </a></li>
<li id="menu-item-7236" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-7236"><a href="recruitment-process/index.html">Dental Implants </a></li>
</ul></div>					</div>
