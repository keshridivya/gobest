...
<link rel="shortcut icon" href="wp-content/themes/clove/images/favicon.png" type="image/x-icon">
  <title>
  Wakad Branch - Gobest Dentist </title>
...
$subject = 'Wakad Form from Website';
...
if (!empty($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest') {
    ...
    echo "alert('ppppp')";
    header("location:dentist-near-me-wakad-hinjewadi-dange-chowk.php.");
...
@keyframes hideBlack {
  ...
  to { clip-path: polygon(100% 0, 100% 0, 100% 100%, 100% 100%); }
    ...
    <style>
.mask1 {
  -webkit-mask: radial-gradient(rgba(0, 0, 0, 1), transparent 250%); 
  /* mask-image: color  */
  ...
  mask-repeat: no-repeat;    
    ...
    <img src="assets/img/research-image/8.jpg" alt="Avatar" class="rounded" style="width:100%">
</div>
<section class="root">
            <div class="container">
            <div class="root-info ">
    <h2 style="font-family: Anton, sans-serif; font-size:50px; line-height:200%;  text-shadow: 2px 1px #fe235b;" class="mb-3 text-center" >Gobest Dentist In Wakad.</h2>
    </div>
    <div class="row">
    <div class="col-lg-4">
                        <div class="root-info py-5">
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3">Address:</h2>
                            <h5 style="font-family: 'Lora', sans-serif;font-family: 'Muli', sans-serif; font-size:20px; line-height: 200%;" class="mb-3">Sonigara Landmark, Shop No. 302, Kaspate Wasti, Wakad, Pimpri-Chinchwad, Maharashtra 411057</h5>
                        </div>
                    </div>
...
<section class="root mt-0 pt-0">
    ...
    <div class="row">
      ...
      <div class="col-sm-12">
      <input type="submit" name="subm" class="btn btn-primary" value="Submit" onclick="return confirm('Thanks for Contacting Gobest Dentist. Wakad Branch');"><br>
      </div>
    </div>
  </form>
                        </div>
