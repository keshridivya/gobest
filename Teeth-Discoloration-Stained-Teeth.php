...
<link rel="shortcut icon" href="wp-content/themes/clove/images/favicon.png" type="image/x-icon">
	<title>Teeth Discoloration / Stained Teeth - Gobest Dentist	</title>
  	...
  	<div class="breadcrumb">
		<div class="box">
			<ul>
				...
				<li>Teeth Discoloration / Stained Teeth</li>
			</ul>
		</div> 
	</div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="root-info py-3">
                            <h5 style="font-family: Anton, sans-serif;" class="mb-3">TEETH STAINING TREATMENT</h5>
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3"> ‘Yes! Your teeth stains are preventable!’</h2>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="root-info py-4">
                            ...
                            <!-- <a href="javascript:void()" class="btn mt-3">KNOW MORE BY VISITING OUR EXPERTS </a> -->
                ...
                <div class="row">
                    <div class="col-lg-5 root-order">
                        <div class="root-img pb-5">
                            <img src="images/treatment/Teeth-staining-1.png" alt="Teeth-staining" class="img-fluid">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-7">
                        <div class="root-info py-5">
                            <h5 style="font-family: Anton, sans-serif;" class="mb-3">WHAT</h5>
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3">What are the types of stains?</h2>
                            <p style="font-size:16px; line-height: 200%;">A common problem in humans is associated with discoloration of the teeth. It is then that they have a question, what are the types of staining of teeth and is it possible to get back your natural shade?</p>
                            <p style="font-size:16px; line-height: 200%;"><b>1. Enamel staining</b><br>

                            Such staining affects only the enamel of the teeth, and it will perfectly lend itself to whitening.<br><br>
                            <b> 2. Discoloration inside the tooth</b><br>
                            This staining will spread deep into the tooth, which leads to the appearance of internal stains.<br><br>
                            <b> 3. Tetracycline staining</b><br>
                            The antibiotic tetracycline is also considered to be the cause of the discoloration of the tooth. Sometimes it is prescribed to young mothers 3-4 months of pregnancy or children under seven years of age.<br><br>
                            <b> 4. Fluorosis</b><br>
                            With such a disease, the enamel of the tooth is affected. Excess fluoride in the body is considered to be the main cause of the disease. Fluorosis can develop mainly in children. The disease is accompanied by a change in the color of the tooth from light yellow to light brown.<br><br>
                            <b> 5. Teeth discoloration over the years</b><br>
                            This discoloration of teeth affects almost all people, and it is associated with the natural accumulation of coloring substances throughout life. That is, over time, microcracks, defects appear on the teeth, the enamel layer decreases, which entails color changes.<br><br>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="root-info py-3">
                            ...
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3">  	Which substances are likely to cause stains on teeth?</h2>
                          <p style="font-size:16px; line-height: 200%;">The most popular reason for this tooth darkening is considered to be the consumption of chocolate, dark berries, red wine, etc. Teeth turn yellow especially quickly due to strong tea or coffee. </p>
                           <p style="font-size:16px; line-height: 200%;" class="moretext">As a rule, if a person consumes such a drink for a month, then he runs the risk of acquiring a yellowish tint on his teeth, which cannot be eliminated with the help of regular brushing. Based on this, drinks and foods containing a high level of dyes most often cause darkening of the teeth, while after prolonged use of them, the teeth acquire a shade from yellow to dark brown.<br>The discoloration of the teeth is also strongly manifested in smokers, since nicotine causes the teeth to acquire an unpleasant yellowish or brown tint. Generally, the harder a smoker smokes cigarettes, the longer they smoke, the more likely it is that teeth will turn yellow over time. Basically, in this case, the front teeth are stained, near the gums.</p>
                ...
                <div class="dental root">
                  <div class="container">
                    ...
                    <h2 style="font-family: Anton, sans-serif;" class="mb-3">How can you prevent the formation of stains on teeth?</h2>
                    ...
                    <div class="row">
                      <div class="col-lg-7">
                        <div class="root-info">
                           ...
                           <p style="line-height: 200%;">There is the main and simplest tool that will help preserve the whiteness of tooth enamel: a toothbrush. Brush your teeth at least twice a day with a toothbrush and once with a floss. </p>
                           <p style="line-height: 200%;" class="moretext1">Better yet, brush after every meal and snack. Brushing helps prevent teeth stains and yellowing, especially on the gum line. Electric and ultrasonic toothbrushes are much more effective at removing plaque and surface stains from teeth. 
<br>Apart from that you can avoid the food and beverages that are known to cause stains on teeth.<br>Using over the counter whitening agents can help you with whitening of teeth but they might cause irritation to your gums. </p> 
 <a class="moreless-button1" style="color: #ffa500;" href="javascript:void()">Read more</a><br>
<p style="line-height: 200%;">Do talk to our expert dentists for best recommendations.</p>
                           <a href="javascript:void()" class="btn mt-3 toggle1 display">MAKE AN APPOINTMENT </a>
                      ...
                      <div class="col-lg-5">
                        <div class="pt-2">
                            <img src="images/treatment/Teeth-staining-2.png" alt="Teeth-staining" class="img-fluid">
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <section class="root">
             ...
             <div class="col-lg-12">
                 <div class="root-info py-3">
                     ...
                     <h2 style="font-family: Anton, sans-serif;" class="mb-3"> 	How can we help you prevent stains?</h2>
                   <p style="font-size:16px; line-height: 200%;">To spot potential dental problems in time, visit your dentist regularly for checkups and professional cleaning. Modern methods of cleaning and polishing used in dentistry will allow you to get rid of any stains on your teeth effectively and painlessly.</p>
         ...
         <div class="row">
                <div class="col-lg-12">
                 <div class="root-info py-3">
                 <h5 style="font-family: Anton, sans-serif;" class="mb-3">WHAT</h5>
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3"> What are the treatment options for teeth staining?</h2>
                 </div>
                </div>
          </div>
          <div class="row">
                    ...
                    <div class="col-lg-5 root-order">
                        ...
                        <div class="root-img pb-5">
                            <img src="images/treatment/Teeth-staining-3.png" alt="Teeth-staining" class="img-fluid">
                        </div>
                    </div>
                    <div class="col-lg-7">
                        <div class="root-info py-5">
                        <p style="font-size:16px; line-height: 200%;"><b>1. Scaling</b> <br>Some of the extrinsic surface stains can be removed the procedure of scaling. It is a simple procedure which may or may not require local anesthesia. It involves scraping of stains and tartar from the surface of your tooth using an ultrasonic device. It may require more than one appointment depending on the severity of stains.<br>
                             Note: Replace Dental Crowns by scaling: Simple procedure which is very effective in removing extrinsic stains
                           <br><br>
                           <b>2. In-office bleaching procedures</b><br>
                           ...
                           <br><br>
                           <b>3. Veneers</b><br>
                           Veneers are shells of tooth coloured material placed over front surface of teeth usually indicated to improve the appearance of smile. They are minimally invasive procedure recommended for stains in front teeth which cannot be removed by scaling.<br><br>
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingOne1">
                              <a data-toggle="collapse" data-parent="#accordionEx" href="#collapseOne1" aria-expanded="true"
                                ...
                                Is tooth discoloration bad? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingTwo2">
                              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseTwo2"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                Can all types of tea stain my teeth? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingThree3">
                              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseThree3"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                               	Is teeth staining reversible?  <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="offset-lg-4 col-lg-4">
                            <iframe width="100%" height="315" src="https://www.youtube.com/embed/djB3Tl5HfiU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
