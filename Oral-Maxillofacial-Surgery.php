...
<link rel="shortcut icon" href="wp-content/themes/clove/images/favicon.png" type="image/x-icon">
	<title>Oral & Maxillofacial Surgery - Gobest Dentist	</title>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="root-info py-3">
                            <h5 style="font-family: Anton, sans-serif;" class="mb-3 text-uppercase">Oral & Maxillofacial Surgery</h5>
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3"> ‘Diagnosis, treatments and rehabilitation. We have it all!’</h2>
                            <p style="font-size:16px; line-height: 200%;">The cyst and tumors of oral cavity are relatively rare lesions that can develop either in jaw bone or in soft tissues of oral cavity. They are sometimes referred to as odontogenic cyst and tumors. They are usually non-cancerous but can sometime turn to be aggressive causes extensive destruction of surrounding bone and soft tissues if not treated on time.</p>
                        </div>
                ...
                <div class="col-lg-12">
                        <div class="root-info py-3">
                            ...
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3"> 	What kind of abnormal lesions can develop in oral cavity?</h2>
                            <p style="font-size:16px; line-height: 200%;">It is estimated that about 10% people develop abnormal growth in oral cavity on an average.</p>
                            <p style="font-size:16px; line-height: 200%;">It can be any one of the following types:</p>
                        </div>
                      

                    </div>
                <div class="col-lg-5 root-order">
                <div class="root-img pb-5">
                            <img src="images/treatment/Oral-and-Maxillofacial-surgery1.png" alt="Oral-and-Maxillofacial-surgery" class="img-fluid">
                        </div>
                </div>
                    <div class="col-lg-7">
                        <div class="root-info py-4">
                           ...
                           <p style="font-size:16px; line-height: 200%;" class="moretext">The most common type of cysts are known to grow from the developmental tissues which were originally supposed to grow into your normal oral hard and soft tissues. After the growth period, these developmental tissues generally become inactive. Sometimes an abnormal stimulus cause these tissues to re-activate and grow to form a cyst. Due to the growing fluid and expanding cyst, it can cause the destruction of the surrounding tissues to create space for itself.</p>
                            ...
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3">  2.	Jaw tumor.</h2>
                            <p style="font-size:16px; line-height: 200%;">A jaw tumor is a type of lesion where there is an abnormal growth of tissues inside the hard or soft tissues of oral cavity.</p>
                           <p style="font-size:16px; line-height: 200%;" class="moretext1">Tumors are also believed to be originating from the developmental cells that originally form the hard and soft tissues of your oral cavity. Some may also form from bone, cartilage or other oral tissues. Most of the jaw tumors can be removed easily without causing much damage if proper treatment is initiated on time.</p>
                           
                            <a class="moreless-button1" href="javascript:void().">Read more</a>
                            <br><br>
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3">  3.	Jaw cancer</h2>
                            <p style="font-size:16px; line-height: 200%;">If the abnormal growth spreads very speedily causing rapid destruction of surrounding tissues, it is termed as jaw cancer.</p>
                           <p style="font-size:16px; line-height: 200%;" class="moretext2">Cancer usually will require a multidisciplinary approach of treatment. It can spread to other parts of the body as well. With advances in technology, it is possible to completely cure cancer. </p>
                ...
                <!-- <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="root-info py-5">
                            ...
                            <h2 class="mb-3"> Who needs orthodontic treatment and why?</h2>
                            <p>Confidence in your smile can positively change your life, which is why consulting with a dentist to help you create the healthiest and most attractive smile is so important.</p>
                          <p>A beautiful, straight smile not only means your teeth are easier to brush, it also helps you gain confidence and reduce stress.</p>
                            <p>Looking for <strong> best dentist for braces in Pune?</strong></p>
                            <a href="javascript:void()" class="btn mt-3">CONTACT US </a>
                        </div>
                    </div>
                    <div class="col-lg-5 root-order">
                        <div class="root-img pb-5">
                            <img src="image/treatment/ortho-2.png" alt="orthodontic" class="img-fluid">
                        </div>
                    </div>
                ...
                <div class="dental root">
                  <div class="container">
                    <h5 style="font-family: Anton, sans-serif;" class="mb-3">WHAT</h5>
                    <h2 style="font-family: Anton, sans-serif;" class="mb-3"> What problems can be caused by cyst and tumors?</h2>
                    ...
                    <div class="row">
                      <div class="col-lg-8">
                        <div class="root-info">
                            ...
                            <h3 style="width:100%; font-family: Anton,sans-serif;"> Gradual bone destruction.</h3>
                            <h3 style="width:100%; font-family: Anton,sans-serif;"> Weakening of jaw.</h3>
                            <h3 style="width:100%; font-family: Anton,sans-serif;"> Loosening of teeth.</h3>
                            <h3 style="width:100%; font-family: Anton,sans-serif;"> Changes in bite.</h3>
                            <h3 style="width:100%; font-family: Anton,sans-serif;"> Pain.</h3>
                            <h3 style="width:100%; font-family: Anton,sans-serif;"> Swelling.</h3>
                            <h3 style="width:100%; font-family: Anton,sans-serif;">Nerve compression causing numbness of lips, gums and teeth.</h3>
                            <br>
              ...
              <div class="container">
                ...
                <div class="row">
                  <div class="col-lg-12">
                        <div class="root-info py-3">
                            <h5 style="font-family: Anton, sans-serif;" class="mb-3">WHAT</h5>
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3"> What are the treatment options available?</h2>
                            <p style="font-size:16px; line-height: 200%;">The treatment procedure depends on the type of cyst or tumor. The entire phase of treatment can be divided into the following stages:</p>
                           
                            <h6 style="font-family: Anton, sans-serif;" class="mb-3">1.	Initial Evaluation</h6>
                            <p style="font-size:16px; line-height: 200%;">In this appointment you can expect us to do a physical examination and obtain a detailed history to advice for required investigation.</p>
                            <div class="moretext4"><p style="font-size:16px; line-height: 200%;">After knowing your concern and a thorough physical examination, we might suggest you to go for:  <br><ul>
                        <li><b>X-ray</b><br>It is useful for identification of abnormal tissues and also important to guide the required surgical treatment.</li>
                        <li><b>Biopsy</b><br>Biopsy is done by taking a sample from the abnormal growth and sending it to the laboratory for testing. It is then determined as to which type of lesion has occurred. This is important in deciding the type of treatment as some lesions are aggressive and fast growing. So they require comparatively big surgeries then the lesions which are slow growing and non-invasive.</li>
                            </ul></p></div>
                           
                           <a class="moreless-button4" href="javascript:void().">Read more</a>
                           <br><br>
                           <h6 style="font-family: Anton, sans-serif;" class="mb-3"> 2. The surgical phase</h6>
                         <div class="row">
                           <div class="col-lg-5 root-order">
                                <div class="root-img">
                                    <img src="images/treatment/Oral-and-Maxillofacial-surgery-2.png" alt="Oral-and-Maxillofacial-surgery" class="img-fluid">
                                </div>
                            </div>
                        <div class="col-lg-7">
                            <div class="root-info py-5">
                            
                                <p style="font-size:16px; line-height: 200%;">Depending on the type of lesion, your surgical treatment may include any of the following:</p>
                                    <ul class="list-style">
                                    <li><p style="font-size:16px; line-height: 200%;"><i class="fa fa-plus" style="top: 10px;"></i><b>Excision</b><br>Also known as Enucleation, it involves complete removal of cyst or tumor.</p>
                                    <p style="font-size:16px; line-height: 200%;" class="moretext5">
                                    It may sometimes involve the removal of surrounding damaged bone or tissue as well. It is possible to re-build the remove tissue in the same procedure if deemed necessary.
                                    </p>
                                    <a class="moreless-button5" href="javascript:void().">Read more</a>
                                <br><br>
                                    </li>
                                    <li>
                                        <p style="font-size:16px; line-height: 200%;"><i class="fa fa-plus" style="top: 10px;"></i><b>Resection or partial mandibulectomy</b>
                                        This procedure involves complete removal of the concerned lesion along with the removal of some part of your jaw.
                                        </p>
                                        <p style="font-size:16px; line-height: 200%;" class="moretext6">
                                        ...
                                        <br>Titanium plates and screw may be required to the jaw initially.
                                        <br>Reconstruction of the removed tissues can be done either in the same appointment or might require a second surgery.

                                    </p>
                                    <a class="moreless-button6" href="javascript:void().">Read more</a>
                                <br><br>
                                    </li>
                ...
                <div class="row">
                    <div class="col-lg-5 root-order">
                        <div class="root-img pb-5">
                            <img src="images/treatment/Oral-and-Maxillofacial-surgery-3.png" alt="Oral-and-Maxillofacial-surgery" class="img-fluid">
                        </div>
                    </div>
                    <div class="col-lg-7">
                        <div class="root-info py-5">
                           
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3">Post-operative care after surgery:</h2>
                           <p style="font-size:16px; line-height: 200%;">Now that you have gone through the main part of treatment i.e surgery, you will want to take care to ensure speedy recovery and return back to normal life as soon as possible.</p>
                              <ul  class="list-style">
                                  <li><i class="fa fa-plus"></i><b>Follow proper instructions</b><br><p style="font-size:16px; line-height: 200%;">You might be advised not to brush your teeth or use a mouthwash for some time as your mouth becomes increasingly sensitive after the surgery.<br>But it is necessary to keep your mouth clean as advised by the oral surgeon by using salt water gargles. Whatever it is, important part is to follow all the instructions strictly.</p></li>
                                  <li><i class="fa fa-plus"></i><b>Proper diet</b><br><p style="font-size:16px; line-height: 200%;">Hot drinks should be avoided as they have the probability to burn the operated tissues. It is advisable to stick to soft diet for at least for a few days after surgery. Avoid smoking and alcohol in any form for speedy recovery.</p></li>
                                  <li><i class="fa fa-plus"></i><b>Proper medication</b><br><p style="font-size:16px; line-height: 200%;">You might feel a little soreness in the jaw for some days after surgery and it is completely normal. It is important that you properly take your antibiotics and pain killers as advised by the surgeon.</p></li>
                                  <li><i class="fa fa-plus"></i><b>Regular follow-ups</b><br><p style="font-size:16px; line-height: 200%;">It is mandatory they you go for all follow up visits so that we can check the healing process and instruct you accordingly.</p></li>
                                  
                              </ul>
                              <p style="font-size:16px; line-height: 200%;">Worried about rehabilitation after surgery?</p>
                              <a href="contact-us.php" class="btn mt-3">CONTACT US </a>
                        </div>
                    </div>
                </div>
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingOne1">
                              <a data-toggle="collapse" data-parent="#accordionEx" href="#collapseOne1" aria-expanded="true"
                                ...
                                Is there any chance of recurrence of cyst or tumor? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                            ...
                            <div id="collapseOne1" class="collapse show" role="tabpanel" aria-labelledby="headingOne1"
                              ...
                              <div class="card-body">
                              Most of the procedures are performed to include all the margins of the lesion till normal surrounding tissues are reached. Therefore the chances of recurrence are less but not nil. Some type of cyst and tumors can show up again although it’s rare.
                              </div>
                            </div>
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingTwo2">
                              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseTwo2"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                              How long will it take to return to normal routine?<i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                            ...
                            <div id="collapseTwo2" class="collapse" role="tabpanel" aria-labelledby="headingTwo2"
                              data-parent="#accordionEx">
                              <div class="card-body">
                              The approximate time of recovery is estimated to be about 2 weeks after surgery. The exact time of recovery however differs from person to person and also depends on the type of surgery done.
                              </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="root-info">
                                ...
                                <h2 style="font-family: Anton, sans-serif;" class="mb-4 text-center"> Videos</h2> 
                            </div>
                        </div>
                        <!--<div class="offset-lg-2 col-lg-4">
                            <iframe width="100%" height="315" src="https://www.youtube.com/embed/7wrO2S0wlmk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>-->
                        <div class="offset-lg-4 col-lg-4">
                            <iframe width="100%" height="315" src="https://www.youtube.com/embed/g-PcaCGsUYY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                    </div>
                </div>
            </section> 
