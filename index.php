   ...
   <div class="patients_speaks_wrap">
    ...
    <?php
      ...
      <div class="item item1 ">
        ...
        <iframe width="260" id="player0" height="320" src="https://www.youtube.com/embed/<?php echo $d['link']; ?>?enablejsapi=1&amp;origin=http%3A%2F%2Ffiddle.jshell.net" class="iframe-video yt_players" title="YouTube video player" frameborder="0"  allowfullscreen></iframe> 
