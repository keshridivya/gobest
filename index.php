    ...
    <?php
      ...
      <div class="item item1 ">
       <div class="video-box">
        ...
        <iframe width="260" height="320" id="<?php echo $d['id']; ?>" src="https://www.youtube.com/embed/<?php echo $d['link']; ?>?enablejsapi=1&amp;origin=http%3A%2F%2Ffiddle.jshell.net" class="iframe-video yt_players" title="YouTube video player" frameborder="0"  allowfullscreen="1"></iframe> 
