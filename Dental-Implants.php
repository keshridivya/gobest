...
<title>Dental Implants - Gobest Dentist	</title>
                ...
                <?php include("include/treatments.php") ?>
                    ...
                    <div class="col-lg-12">
                        <div class="root-info py-3">
                            <h5 style="font-family: Anton, sans-serif;" class="mb-3">DENTAL IMPLANTS</h5>
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3"> ‘Loss of tooth is not the end of your smile!’</h2>
                            <p style="font-size:16px; line-height: 200%;">Dental Implants from our clinic will not only restore the looks but also health back into smile!</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-7">
                        <div class="root-info py-4">
                            ...
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3">   What is a dental implant?</h2>
                            <p style="font-size:16px; line-height: 200%;">Of course no artificial technology can beat your natural teeth, but if you don’t have that option, an implant is the next best option. Our dental implants look and feels just like your natural teeth.  <br>
                            Dental implants are metal posts that are surgically positioned into the jawbone beneath your gums to provide a secure support for the prosthesis. </p>
                            
                            <p style="font-size:16px; line-height: 200%;" class="moretext">Types of Dental Implants:<br>
There are two main types of dental implant options for you to choose from:<br>
<b>1.  Endosteal implants</b><br>

These are the types of implants which are surgically implanted directly into your jawbone by your dentist. There is a specific time period required for your gum tissue to heal around the implanted screw. After waiting for the healing period, a second surgery is performed to connect a post to the implanted screw. The final step is the fabrication and cementation of the prosthesis which can be either single tooth or a bridge (multiple teeth grouped together).<br><br>

<b>2.  Subperiosteal implants</b><br>
These types of implants consists of a metal frame that is inserted into the jawbone just below the gum tissue. They become integrated with your jaw bone over time through the process known as osteointegration. You may be a suitable candidate for this implant if you have bone loss in your jaw or the shape/health of your jaw is not suitable for insertion of metal required for endosteal implants.
                            ...
                            <p style="font-size:16px; line-height: 200%;">We ensure that our implants are made of highest quality materials for a lifetime durability!</p>
                    ...
                    <div class="col-lg-5 pr-xl-0">
                        <div class="root-img pb-4">
                            <img src="images/treatment/implant1.png" alt="Implant" class="img-fluid">
                        </div>
                ...
                <div class="dental root">
                  <div class="container">
                    ...
                    <h2 style="font-family: Anton, sans-serif;" class="mb-3">You are a good candidate for implant if:</h2>
                    
                    <div class="row">
                      <div class="col-lg-7">
                        <div class="root-info">
                            <h3 style="width:100%; font-family: Anton, sans-serif;" >You have good overall health.</h3>
                            <h3 style="width:100%; font-family: Anton, sans-serif;" >Have healthy gums.</h3>
                            <h3 style="width:100%; font-family: Anton, sans-serif;" >Have enough jaw bone to anchor the implant.</h3>
                      ...
                      <!-- <div class="col-lg-5">
                        <div>
                            <img src="image/treatment/extraction1.jpg" alt="Extraction" class="img-fluid">
                        </div>
                      </div> -->
              ...
              <div class="container">
                <div class="row">
                    <div class="col-lg-5 root-order">
                        <div class="root-img">
                            <img src="images/treatment/implant2.png" alt="Implant" class="img-fluid" >
                        </div>
                    </div>

                    <div class="col-lg-7">
                        <div class="root-info py-5">
                            <h5 style="font-family: Anton, sans-serif;" class="mb-3">PARTS</h5>
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3"> Parts of dental implants:</h2>
                            <p style="font-size:16px; line-height: 200%;">There are three main elements of a dental implant:</p>
                            <p style="font-size:16px; line-height: 200%;"><b>1.  The Implant Post</b><br>

It is designed to closely replicate the shape of tooth root and is inserted into the jaw bone during a minor surgical procedure.<br>
They come in variety of shapes and sizes and is hollow on inside to allow the abutment to be screwed into the post.<br><br>

<b>2.  The Abutment</b><br>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="root-info py-5">
                            ...
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3">  The Process!</h2>
                            <p style="font-size:16px; line-height: 200%;"><b>So you decided to go for an implant? Congratulations! You have made the best decision in terms of your oral health.</b></p>
                            <p style="font-size:16px; line-height: 200%;"><b>Step 1: The Initial Evaluation</b><br>

The first step will be a comprehensive evaluation of your jaw bone to decide which type of implant will best suit you. This may include X-rays and taking impressions.  <br>
Our dentist will discuss all your medical conditions and medications that you are taking. This may determine the pre and post-surgical steps like prescription of antibiotics to prevent infection.<br>
We will also discuss the surgical anesthesia options that are best suitable for you.<br><br>
...
<p style="font-size:16px; line-height: 200%;"><b>Step 3: Final Restoration</b><br>
...
<br>
                            ...
                            <p style="font-size:16px; line-height: 200%;">Your comfort is our priority!</p>
                            <a href="javascript:void()" class="btn mt-3 toggle1 display">BOOK YOUR APPOINTMENT </a>

                        </div>
                    </div>

                    <div class="col-lg-5 root-order pt-5">
                        <div class="root-img">
                            <img src="images/treatment/implant3.png" alt="Implant" class="img-fluid" >
                        </div>
                    </div>
                ...
                <div class="row">
                     <div class="col-lg-12">
                        <div class="root-info py-5">
                            ...
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3">   Why will you love our dental implants?</h2>
                            <ul class="list-style">
                                <li><i class="fa fa-plus"></i> Easier after-care.</li>
                                <li><i class="fa fa-plus"></i> Up to lifetime of durability.</li>
                                <li><i class="fa fa-plus"></i> Natural look and feel.</li>
                                <li><i class="fa fa-plus"></i> Will improve bone and gum health.</li>

                            </ul><br>
                             <p style="font-size:16px; line-height: 200%;">Restore your smile today!</p>
                            <a href="javascript:void()" class="btn mt-3 toggle1 display">BOOK YOUR APPOINTMENT </a>
                        </div>
                     </div>
                </div>
                        ...
                        <div class="accordion md-accordion" id="accordionEx" role="tablist" aria-multiselectable="true">
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingOne1">
                              <a data-toggle="collapse" data-parent="#accordionEx" href="#collapseOne1" aria-expanded="true"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                  What are the advantages of dental implants? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                            ...
                            <div id="collapseOne1" class="collapse show" role="tabpanel" aria-labelledby="headingOne1"
                              ...
                              <div class="card-body">
                                Dental implants are anchored very strongly into your jawbone thus allowing you to apply the same force while chewing as you would apply on your natural tooth. Dental implants are made up of noble metal like Titanium so it won’t catch decay. Dental implants are the only treatment option available currently that simulate your natural tooth root thus preventing bone loss.
                              </div>
                            </div>
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingTwo2">
                              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseTwo2"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                  What are the disadvantages of dental implants? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                            ...
                            <div id="collapseTwo2" class="collapse" role="tabpanel" aria-labelledby="headingTwo2"
                              data-parent="#accordionEx">
                              <div class="card-body">
                              Dental implants require sufficient amount of bone to be successful. Absence of it will require additional procedures like bone grafting which can add to the cost. But this cost will be worth it in near future.
                              </div>
                            </div>
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingThree3">
                              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseThree3"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                  What is the success rate of dental implants? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                            ...
                            <div id="collapseThree3" class="collapse" role="tabpanel" aria-labelledby="headingThree3"
                              data-parent="#accordionEx">
                              <div class="card-body">
                                It depends on the health and habits of individuals. For a healthy individual with good oral hygiene and good health, a success rate of about 90-95% is expected.
                              </div>
                            </div>
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingThree4">
                              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseThree4"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                   Are dental implants removable like dentures or do they stay in your mouth? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                            ...
                            <div id="collapseThree4" class="collapse" role="tabpanel" aria-labelledby="headingThree4"
                              data-parent="#accordionEx">
                              <div class="card-body">
                                Dental implants need nod to be removed. They are fixed solidly into your jaw bone simulating the natural root of your tooth and providing a strong anchor for the overlying crown.
                              </div>
                            </div>
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingThree5">
                              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseThree5"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                    Does it hurt to get dental implants? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                            ...
                            <div id="collapseThree5" class="collapse" role="tabpanel" aria-labelledby="headingThree5"
                              data-parent="#accordionEx">
                              <div class="card-body">
                                With the anaesthesia available at the time of treatment and helpful instructions for home care, patients usually report that they feel better than anticipated. Often, they return to their daily chores on the subsequent day. While there could also be some discomfort and bruising, this typically lasts only a brief time.
                              </div>
                            </div>
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingThree6">
                              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseThree6"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                  How do I care for my dental implants? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                            ...
                            <div id="collapseThree6" class="collapse" role="tabpanel" aria-labelledby="headingThree6"
                              data-parent="#accordionEx">
                              <div class="card-body">
                                    Well-placed and well-cared dental implants have the potential to last for many years. Caring for teeth restored with dental implants is simply like caring for your natural teeth: brush, floss and visit your dentist for normal cleanings and check-ups
                              </div>
                            </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="offset-lg-4 col-lg-4">
                            <iframe width="100%" height="315" src="https://www.youtube.com/embed/MzfzuRKJzNU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                       <!--  <div class="col-lg-4">
