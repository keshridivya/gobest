...
<link rel="shortcut icon" href="wp-content/themes/clove/images/favicon.png" type="image/x-icon">
	<title>Scaling-Polishing - Gobest Dentist	</title>
...
<section class="root">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="root-info py-3">
                            ...
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3"> ‘It is more than just a simple cleaning!’</h2>
                          
                        </div>
                    </div>
                    <div class="col-lg-5">
                        <div class="root-img py-3">
                            <img src="images/treatment/scaling-1.png" alt="scaling">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-5">
                        <div class="root-img py-3">
                            <img src="images/treatment/scaling-2.png" alt="scaling">
                        </div>
                    </div>
                    <div class="col-lg-7">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="root-info py-5">
                            ...
                            <h2 style="font-family: Anton, sans-serif;" class="mb-3"> When do I need Scaling?</h2>
                            <p style="font-size:16px; line-height: 200%;">The dentist at GoBest Dentist will thourougly check your entire oral cavity at each visit. If you are adviced to go for scaling, that means you have chronic conditions like chronic generalized periodontitis which needs immediate attention.</p>
                           <p style="font-size:16px; line-height: 200%;">While the best way to know if gum disease complications are occurring is to visit a qualified dentist, there are some signs you can look at before your next appointment.</p>
                            <ul class="list-style">
                                <li><i class="fa fa-plus"></i> Swollen gums.</li>
                                <li><i class="fa fa-plus"></i> Tender and painful gums.</li>
                                <li><i class="fa fa-plus"></i> Bleeding gums.</li>
                                <li><i class="fa fa-plus"></i> Falling gum line.</li>
                                <li><i class="fa fa-plus"></i> Bad breath.</li>
                                <li><i class="fa fa-plus"></i> Loose teeth.</li>
                                <li><i class="fa fa-plus"></i> New gaps between the teeth.</li>
                                <li><i class="fa fa-plus"></i> Pain when chewing.</li>
                            </ul>
                    ...
                    <div class="col-lg-5 root-order">
                        <div class="root-img pb-5">
                            <img src="images/treatment/scaling-3.png" alt="scaling" class="img-fluid">
                        </div>
                    </div>
                </div>
              </div>
                ...
                <div class="dental root">
                  <div class="container">
                    ...
                    <h5 style="font-family: Anton, sans-serif;" class="mb-3">WHAT</h5>
                           ...
                           <p style="line-height: 200%;">It can occur due to variety of reasons some of which include the following:</p>
                    <div class="row">
                      <div class="col-lg-7">
                        <div class="root-info">
                            <!-- <h5 class="mb-3">WHY</h5> -->
                            ...
                            <h3 style="width:100%; font-family: Anton,sans-serif;">Increasing age.</h3>
                            <h3 style="width:100%; font-family: Anton,sans-serif;">Hormonal changes in body.</h3>
                            <h3 style="width:100%; font-family: Anton,sans-serif;">Inadequate nutrition.</h3>
                            <h3 style="width:100%; font-family: Anton,sans-serif;">Heredity.</h3>
                            <h3 style="width:100%; font-family: Anton,sans-serif;">Some systemic diseases.</h3>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-12">
                      <div class="root-info py-5">
                          ...
                          <h2 style="font-family: Anton, sans-serif;" class="mb-3">Care and Recovery after treatment:</h2>
                         <p style="font-size:16px; line-height: 200%;">During the first few days after treatment, bleeding may occur and should gradually subside. On a return visit, our dentist will assess the healing of the gums and check for the reduction in the size of the periodontal pockets.</p>
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingOne1">
                              <a data-toggle="collapse" data-parent="#accordionEx" href="#collapseOne1" aria-expanded="true"
                                ...
                                Is scaling and root planning a painful procedure?  <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                            ...
                            <div id="collapseOne1" class="collapse show" role="tabpanel" aria-labelledby="headingOne1"
                              ...
                              <div class="card-body">
                              Scaling and root planning is not a painful procedure as such. We use an anesthetic gel to numb the concerned areas before initiating the procedure. You might feel a sense of tenderness over the gums after the procedure. It usually subsides without any medication.
                              </div>
                            </div>
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingTwo2">
                              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseTwo2"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                Does scaling make the teeth weak?<i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                            ...
                            <div id="collapseTwo2" class="collapse" role="tabpanel" aria-labelledby="headingTwo2"
                              data-parent="#accordionEx">
                              <div class="card-body">
                              Scaling by no means does any harm to your teeth. Infact not opting for scaling even after the suggestion of your dentist can weaken the support of your teeth leading to loosening and subsequent loss of teeth.
                              </div>
                            </div>
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingThree3">
                              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseThree3"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                How to reduce sensitivity after scaling and root planning? <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                            ...
                            <div id="collapseThree3" class="collapse" role="tabpanel" aria-labelledby="headingThree3"
                              data-parent="#accordionEx">
                              <div class="card-body">
                              Use the anti-sensitivity mouthwash and toothpaste prescribed by your dentist as guided. Eat soft food for a few days after undergoing the procedure. Avoid eating too hot or too cold food to further reduce the post-operative sensitivity.
                              </div>
                            </div>
                          ...
                          <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingThree4">
                              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseThree4"
                                ...
                                <h5 style="font-family: Anton, sans-serif;" class="mb-0">
                                Does scaling cause formation of gaps between the teeth?  <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                              </a>
                            </div>
                            ...
                            <div id="collapseThree4" class="collapse" role="tabpanel" aria-labelledby="headingThree4"
                              data-parent="#accordionEx">
                              <div class="card-body">
                              Sometimes there is a deposition of layers of calculus in the teeth. The removal of this accumulated deposits from teeth during the process of scaling can give a false feeling of gap formation. However this is not the real scenario.
                              </div>
                            </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="offset-lg-4 col-lg-4">
                            <iframe width="100%" height="315" src="https://www.youtube.com/embed/_dinmAOtcqE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
